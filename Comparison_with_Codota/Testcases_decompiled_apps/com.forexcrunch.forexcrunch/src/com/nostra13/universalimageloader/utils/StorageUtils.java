...
public final class StorageUtils {
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.mkdirs()) {
            C0847L.m2150w("Unable to create external cache directory", new Object[0]);
            return null;
        }
        try {
            ...
            C0847L.m2149i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return appCacheDir;
        }
    }
}
