...
import com.slidingmenu.lib.C1038R;
...
public class SlidingActivityHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
        this.mSlidingMenu = (SlidingMenu) LayoutInflater.from(this.mActivity).inflate(C1038R.layout.slidingmenumain, (ViewGroup) null);
    }
