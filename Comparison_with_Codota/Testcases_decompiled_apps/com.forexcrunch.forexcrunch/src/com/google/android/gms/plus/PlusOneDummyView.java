...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C0748b implements C0750d {
        ...
        public Drawable getDrawable(int size) {
            ...
            try {
                ...
                return resources.getDrawable(resources.getIdentifier(str, ImageDownloader.SCHEME_DRAWABLE, GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE));
    ...
    private static class C0749c implements C0750d {
        ...
        public Drawable getDrawable(int size) {
            ...
            return this.mContext.getResources().getDrawable(this.mContext.getResources().getIdentifier(str, ImageDownloader.SCHEME_DRAWABLE, this.mContext.getPackageName()));
        }

        public boolean isValid() {
            return (this.mContext.getResources().getIdentifier("ic_plusone_small_off_client", ImageDownloader.SCHEME_DRAWABLE, this.mContext.getPackageName()) == 0 || this.mContext.getResources().getIdentifier("ic_plusone_medium_off_client", ImageDownloader.SCHEME_DRAWABLE, this.mContext.getPackageName()) == 0 || this.mContext.getResources().getIdentifier("ic_plusone_tall_off_client", ImageDownloader.SCHEME_DRAWABLE, this.mContext.getPackageName()) == 0 || this.mContext.getResources().getIdentifier("ic_plusone_standard_off_client", ImageDownloader.SCHEME_DRAWABLE, this.mContext.getPackageName()) == 0) ? false : true;
        }
    }
    ...
    public PlusOneDummyView(Context context, int size) {
        ...
        button.setBackgroundDrawable(m2122bx().getDrawable(size));
        Point T = m2121T(size);
        addView(button, new FrameLayout.LayoutParams(T.x, T.y, 17));
    }

    /* renamed from: T */
    private Point m2121T(int i) {
        int i2 = 24;
        int i3 = 20;
