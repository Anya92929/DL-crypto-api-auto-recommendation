...
import com.google.android.gms.internal.C0595i;
import com.google.android.gms.internal.C0607m;
...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog m544a(int i, Activity activity, int i2, DialogInterface.OnCancelListener onCancelListener, int i3) {
        ...
        switch (i) {
            case 0:
                return null;
            case 1:
                return message.setTitle(C0334R.string.common_google_play_services_install_title).create();
            case 2:
                return message.setTitle(C0334R.string.common_google_play_services_update_title).create();
            case 3:
                return message.setTitle(C0334R.string.common_google_play_services_enable_title).create();
            case 4:
            case 6:
                return message.setTitle(C0334R.string.common_google_play_services_unknown_issue).create();
            case 5:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0334R.string.common_google_play_services_invalid_account_title).create();
            case 7:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0334R.string.common_google_play_services_network_error_title).create();
            case 8:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(C0334R.string.common_google_play_services_unknown_issue).create();
            case 9:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0334R.string.common_google_play_services_unsupported_title).create();
            case 10:
    ...
    /* renamed from: a */
    public static Intent m545a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m551b(i2) ? m554c(context) ? C0607m.m1841l(GOOGLE_PLAY_SERVICES_PACKAGE) : C0607m.m1840k("com.google.android.apps.bazaar") : C0607m.m1840k(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C0607m.m1838i(GOOGLE_PLAY_SERVICES_PACKAGE);
            default:
                return null;
        }
    }
    ...
    /* renamed from: a */
    public static String m546a(Context context, int i) {
    ...
    /* renamed from: a */
    public static boolean m547a(Resources resources) {
        return (C0427as.m909an() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m552b(resources);
    }

    /* renamed from: a */
    private static byte[] m548a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m549a(byte[][]... bArr) {
        int i = 0;
    ...
    /* renamed from: b */
    public static String m550b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                String string = m547a(context.getResources()) ? resources.getString(C0334R.string.common_google_play_services_install_text_tablet) : resources.getString(C0334R.string.common_google_play_services_install_text_phone);
                return m551b(i2) ? string + " (via Bazaar)" : string;
            case 2:
                String string2 = resources.getString(C0334R.string.common_google_play_services_update_text);
                return m551b(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
                return resources.getString(C0334R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0334R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0334R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0334R.string.common_google_play_services_unsupported_text);
            default:
                return resources.getString(C0334R.string.common_google_play_services_unknown_issue);
        }
    }

    /* renamed from: b */
    static boolean m551b(int i) {
        switch (m553c(i)) {
            case 0:
                return !m556g();
            case 1:
    ...
    /* renamed from: b */
    private static boolean m552b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C0427as.m911ap() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    /* renamed from: c */
    private static int m553c(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
    ...
    /* renamed from: c */
    private static boolean m554c(Context context) {
        if (f781J) {
            return f783L;
        }
        try {
            return m548a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f780I) != null;
    ...
    /* renamed from: c */
    private static byte[] m555c(String str) {
        try {
    ...
    /* renamed from: g */
    public static boolean m556g() {
        return f781J ? f782K : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m544a(errorCode, activity, requestCode, (DialogInterface.OnCancelListener) null, -1);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            byte[] a = m548a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f774C);
            if (a == null) {
