...
public interface C0685h extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.h$a */
    public static abstract class C0686a extends Binder implements C0685h {

        /* renamed from: com.google.android.gms.maps.internal.h$a$a */
        private static class C0687a implements C0685h {
        ...
        /* renamed from: E */
        public static C0685h m2000E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0685h)) ? new C0687a(iBinder) : (C0685h) queryLocalInterface;
        }
