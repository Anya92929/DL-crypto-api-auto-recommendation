...
public interface C0490be extends IInterface {

    /* renamed from: com.google.android.gms.internal.be$a */
    public static abstract class C0491a extends Binder implements C0490be {

        /* renamed from: com.google.android.gms.internal.be$a$a */
        private static class C0492a implements C0490be {
            ...
            public void onRemoveGeofencesByPendingIntentResult(int statusCode, PendingIntent pendingIntent) throws RemoteException {
                ...
                try {
                    ...
                    this.f1108a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: q */
        public static C0490be m1309q(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0490be)) ? new C0492a(iBinder) : (C0490be) queryLocalInterface;
        }
