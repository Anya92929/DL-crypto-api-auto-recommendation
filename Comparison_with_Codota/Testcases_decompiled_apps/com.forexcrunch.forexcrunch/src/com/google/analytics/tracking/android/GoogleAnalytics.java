...
public class GoogleAnalytics implements TrackerHandler {
    ...
    private GoogleAnalytics(Context context, AnalyticsThread thread) {
        ...
        this.mThread.requestAppOptOut(new AppOptOutCallback() {
            public void reportAppOptOut(boolean optOut) {
                Boolean unused = GoogleAnalytics.this.mAppOptOut = Boolean.valueOf(optOut);
            }
        });
        this.mThread.requestClientId(new AnalyticsThread.ClientIdCallback() {
            public void reportClientId(String clientId) {
                String unused = GoogleAnalytics.this.mClientId = clientId;
            }
        });
    }
    ...
    public Tracker getTracker(String trackingId) {
        ...
        synchronized (this) {
            ...
            tracker = this.mTrackers.get(trackingId);
            if (tracker == null) {
    ...
    public void sendHit(Map<String, String> hit) {
        synchronized (this) {
            ...
            this.mLastTrackingId = hit.get(ModelFields.TRACKING_ID);
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public String getTrackingIdForAds() {
        return this.mLastTrackingId;
    }

    /* access modifiers changed from: package-private */
    public String getClientIdForAds() {
