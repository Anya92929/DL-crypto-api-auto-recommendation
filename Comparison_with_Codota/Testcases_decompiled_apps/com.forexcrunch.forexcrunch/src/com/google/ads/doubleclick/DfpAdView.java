...
public class DfpAdView extends AdView {
    ...
    public void enableManualImpressions(boolean useManualImpressions) {
        this.f117a.mo3550i().f673t.mo3727a(Boolean.valueOf(useManualImpressions));
    }
    ...
    public void resize(AdSize adSize) {
        this.f117a.mo3553l().setAdSize(adSize);
        this.f117a.mo3550i().f660g.mo3725a().mo3610b(adSize);
    }
}
