...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private static /* synthetic */ int[] f1749x57a4d715 = null;

    /* renamed from: $SWITCH_TABLE$com$handmark$pulltorefresh$library$PullToRefreshBase$Orientation */
    private static /* synthetic */ int[] f1750x9c6cb41e = null;

    /* renamed from: $SWITCH_TABLE$com$handmark$pulltorefresh$library$PullToRefreshBase$State */
    private static /* synthetic */ int[] f1751x9d4cd55f = null;
    ...
    /* renamed from: $SWITCH_TABLE$com$handmark$pulltorefresh$library$PullToRefreshBase$Mode */
    static /* synthetic */ int[] m2136x57a4d715() {
        int[] iArr = f1749x57a4d715;
        if (iArr == null) {
    ...
    /* renamed from: $SWITCH_TABLE$com$handmark$pulltorefresh$library$PullToRefreshBase$Orientation */
    static /* synthetic */ int[] m2137x9c6cb41e() {
        int[] iArr = f1750x9c6cb41e;
        if (iArr == null) {
    ...
    /* renamed from: $SWITCH_TABLE$com$handmark$pulltorefresh$library$PullToRefreshBase$State */
    static /* synthetic */ int[] m2138x9d4cd55f() {
        int[] iArr = f1751x9d4cd55f;
        if (iArr == null) {
                ...
                case 2:
                    if (this.mScrollingWhileRefreshingEnabled || !isRefreshing()) {
                        if (isReadyForPull()) {
                            float y2 = event.getY();
                            float x2 = event.getX();
                            switch (m2137x9c6cb41e()[getPullToRefreshScrollDirection().ordinal()]) {
                                case 2:
    ...
    public final void setState(State state, boolean... params) {
        ...
        switch (m2138x9d4cd55f()[this.mState.ordinal()]) {
            case 1:
                onReset();
                break;
            case 2:
    ...
    /* access modifiers changed from: protected */
    public final void addViewInternal(View child, int index, ViewGroup.LayoutParams params) {
    ...
    public void onPullToRefresh() {
        switch (m2136x57a4d715()[this.mCurrentMode.ordinal()]) {
            case 2:
    ...
    /* access modifiers changed from: protected */
    public final void refreshRefreshableViewSize(int width, int height) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0836R.styleable.PullToRefresh);
        if (a.hasValue(4)) {
        ...
        if (a.hasValue(0)) {
            ...
            Drawable background2 = a.getDrawable(16);
            if (background2 != null) {
    ...
    private boolean isReadyForPull() {
        switch (m2136x57a4d715()[this.mMode.ordinal()]) {
            case 2:
    ...
    private void pullEvent() {
        ...
        switch (m2136x57a4d715()[this.mCurrentMode.ordinal()]) {
            case 3:
                newScrollValue = Math.round(Math.max(initialMotionValue - lastMotionValue, BitmapDescriptorFactory.HUE_RED) / FRICTION);
                itemDimension = getFooterSize();
                break;
            default:
                newScrollValue = Math.round(Math.min(initialMotionValue - lastMotionValue, BitmapDescriptorFactory.HUE_RED) / FRICTION);
    ...
    private final void smoothScrollTo(int scrollValue, long duration) {
        smoothScrollTo(scrollValue, duration, 0, (OnSmoothScrollFinishedListener) null);
    }
