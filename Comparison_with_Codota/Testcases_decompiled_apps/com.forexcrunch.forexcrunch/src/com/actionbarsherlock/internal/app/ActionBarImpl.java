...
public class ActionBarImpl extends ActionBar {
    ...
    private void init(View decor) {
        ...
        this.mActionView = (ActionBarView) decor.findViewById(C0044R.C0045id.abs__action_bar);
        this.mContextView = (ActionBarContextView) decor.findViewById(C0044R.C0045id.abs__action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0044R.C0045id.abs__action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0044R.C0045id.abs__split_action_bar);
        ...
        setHomeButtonEnabled(homeButtonEnabled | z);
        setHasEmbeddedTabs(ResourcesCompat.getResources_getBoolean(this.mContext, C0044R.bool.abs__action_bar_embed_tabs));
    }
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0044R.attr.actionBarWidgetTheme, outValue, true);
