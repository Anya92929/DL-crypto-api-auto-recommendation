...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchable, WeakHashMap<String, Drawable.ConstantState> outsideDrawablesCache) {
        super(context, C0044R.layout.abs__search_dropdown_item_icons_2line, (Cursor) null, true);
    ...
    public Cursor getSuggestions(String query, int limit) {
        String authority;
        if (this.mSearchable == null || (authority = this.mSearchable.getSuggestAuthority()) == null) {
            return null;
        }
        Uri.Builder uriBuilder = new Uri.Builder().scheme(ImageDownloader.SCHEME_CONTENT).authority(authority).query("").fragment("");
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0044R.C0045id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0044R.attr.textColorSearchUrl, colorValue, true);
