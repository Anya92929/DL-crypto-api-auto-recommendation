...
public class MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = MenuInflater.this.mContext.obtainStyledAttributes(attrs, C0044R.styleable.SherlockMenuGroup);
        ...
        public void readItem(AttributeSet attrs) {
            ...
            int i;
            TypedArray a = MenuInflater.this.mContext.obtainStyledAttributes(attrs, C0044R.styleable.SherlockMenuItem);
            ...
            a.getValue(15, value2);
            if (value2.type == 3) {
                str = value2.string.toString();
            } else {
                str = null;
            }
            this.itemActionViewClassName = str;
            TypedValue value3 = new TypedValue();
            a.getValue(16, value3);
            if (value3.type == 3) {
                str2 = value3.string.toString();
            } else {
                str2 = null;
            }
