...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C1053R.attr.vpiLinePageIndicatorStyle);
    }
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            int defaultSelectedColor = res.getColor(C1053R.color.default_line_indicator_selected_color);
            int defaultUnselectedColor = res.getColor(C1053R.color.default_line_indicator_unselected_color);
            float defaultLineWidth = res.getDimension(C1053R.dimen.default_line_indicator_line_width);
            float defaultGapWidth = res.getDimension(C1053R.dimen.default_line_indicator_gap_width);
            float defaultStrokeWidth = res.getDimension(C1053R.dimen.default_line_indicator_stroke_width);
            boolean defaultCentered = res.getBoolean(C1053R.bool.default_line_indicator_centered);
            TypedArray a = context.obtainStyledAttributes(attrs, C1053R.styleable.LinePageIndicator, defStyle, 0);
