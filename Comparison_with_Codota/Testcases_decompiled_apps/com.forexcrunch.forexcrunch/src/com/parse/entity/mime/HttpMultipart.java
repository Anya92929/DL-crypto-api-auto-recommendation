...
public class HttpMultipart {
    private static /* synthetic */ int[] $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode;
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode() {
        int[] iArr = $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode;
        if (iArr == null) {
            ...
            $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode = iArr;
        }
        return iArr;
    }
    ...
    private void doWriteTo(HttpMultipartMode mode2, OutputStream out, boolean writeContent) throws IOException {
        ...
        for (FormBodyPart part : this.parts) {
            ...
            switch ($SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode()[mode2.ordinal()]) {
                case 1:
                    Iterator<MinimalField> it = header.iterator();
                    while (it.hasNext()) {
                        writeField(it.next(), out);
                    }
                    break;
                case 2:
