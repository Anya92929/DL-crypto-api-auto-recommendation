...
class NotificationCompatJellybean {
    ...
    /* renamed from: b */
    private Notification.Builder f0b;
    ...
    public void addBigTextStyle(CharSequence bigContentTitle, boolean useSummary, CharSequence summaryText, CharSequence bigText) {
        Notification.BigTextStyle style = new Notification.BigTextStyle(this.f0b).setBigContentTitle(bigContentTitle).bigText(bigText);
        if (useSummary) {
    ...
    public void addBigPictureStyle(CharSequence bigContentTitle, boolean useSummary, CharSequence summaryText, Bitmap bigPicture) {
        Notification.BigPictureStyle style = new Notification.BigPictureStyle(this.f0b).setBigContentTitle(bigContentTitle).bigPicture(bigPicture);
        if (useSummary) {
            style.setSummaryText(summaryText);
        }
    }
    ...
    public void addInboxStyle(CharSequence bigContentTitle, boolean useSummary, CharSequence summaryText, ArrayList<CharSequence> texts) {
        Notification.InboxStyle style = new Notification.InboxStyle(this.f0b).setBigContentTitle(bigContentTitle);
        if (useSummary) {
            style.setSummaryText(summaryText);
        }
