...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                this.mArrow.offset(cos - f3, (float) ((this.mRingCenterRadius * Math.sin(0.0d)) + ((double) rect.exactCenterY())));
                this.mArrow.close();
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        return (i6 + ((int) (((float) ((intValue2 & 255) - i6)) * f))) | ((i3 + ((int) (((float) ((intValue2 >>> 24) - i3)) * f))) << 24) | ((i4 + ((int) (((float) (((intValue2 >> 16) & 255) - i4)) * f))) << 16) | ((((int) (((float) (((intValue2 >> 8) & 255) - i5)) * f)) + i5) << 8);
    }
