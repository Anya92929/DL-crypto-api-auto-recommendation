...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            return (AutoScrollHelper.constrain(((float) (j - this.mStopTime)) / ((float) this.mEffectiveRampDown), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * this.mStopValue) + (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - this.mStopValue);
        }
