        ...
        while (i11 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    layoutParams.dimWhenOffset = ((i12 + i14) + min) + (measuredWidth / 2) > i10 - paddingLeft;
                    int i15 = (int) (((float) min) * this.mSlideOffset);
                    i7 = i12 + i14 + i15;
                    this.mSlideOffset = ((float) i15) / ((float) this.mSlideRange);
                } else {
                    i13 = (!this.mCanSlide || this.mParallaxBy == 0) ? 0 : (int) ((1.0f - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i7 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i9 = (i10 - i7) + i13;
