...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterViewCompat.OnItemClickListener {
    ...
    class TabView extends LinearLayoutCompat implements View.OnLongClickListener {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            super(context, (AttributeSet) null, C0137R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, this.BG_ATTRS, C0137R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), (AttributeSet) null, C0137R.attr.actionBarTabTextStyle);
    ...
    private SpinnerCompat createSpinner() {
        SpinnerCompat spinnerCompat = new SpinnerCompat(getContext(), (AttributeSet) null, C0137R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), (AttributeSet) null, C0137R.attr.actionBarTabBarStyle);
