...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0137R.C0139id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0137R.C0139id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0137R.C0139id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0137R.C0139id.action_bar_container);
        this.mSplitView = (ActionBarContainer) view.findViewById(C0137R.C0139id.split_action_bar);
        ...
        if (obtainStyledAttributes.getBoolean(C0137R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0137R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0137R.attr.actionBarWidgetTheme, typedValue, true);
