...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0137R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOnItemClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView adapterView, View view, int i, long j) {
                boolean unused = SearchView.this.onItemClicked(i, 0, (String) null);
            }
        };
        this.mOnItemSelectedListener = new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView adapterView, View view, int i, long j) {
                boolean unused = SearchView.this.onItemSelected(i);
            }
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0137R.styleable.SearchView, i, 0);
        this.mTintManager = obtainStyledAttributes.getTintManager();
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0137R.styleable.SearchView_layout, C0137R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0137R.C0139id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0137R.C0139id.search_edit_frame);
        this.mSearchPlate = findViewById(C0137R.C0139id.search_plate);
        this.mSubmitArea = findViewById(C0137R.C0139id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0137R.C0139id.search_button);
        this.mGoButton = (ImageView) findViewById(C0137R.C0139id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0137R.C0139id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0137R.C0139id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0137R.C0139id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0137R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0137R.styleable.SearchView_suggestionRowLayout, C0137R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0137R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0137R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0137R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0137R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0137R.styleable.SearchView_queryHint);
        int i2 = obtainStyledAttributes.getInt(C0137R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0137R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0137R.styleable.SearchView_android_focusable, true));
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0137R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0137R.dimen.abc_dropdownitem_icon_width) : 0;
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0137R.dimen.abc_search_view_preferred_width);
    }
