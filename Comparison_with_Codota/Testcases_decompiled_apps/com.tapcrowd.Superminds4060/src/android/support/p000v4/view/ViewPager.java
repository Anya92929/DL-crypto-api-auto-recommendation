    ...
    public void populate(int newCurrentItem) {
        ...
        if (this.mAdapter == null) {
            ...
            if (curItem != null) {
                ...
                float leftWidthNeeded = (2.0f - curItem.widthFactor) + (((float) getPaddingLeft()) / ((float) getClientWidth()));
                ...
                if (extraWidthRight < 2.0f) {
                    ...
                    float rightWidthNeeded = (((float) getPaddingRight()) / ((float) getClientWidth())) + 2.0f;
