...
class UserListJSONImpl extends TwitterResponseImpl implements UserList, Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        this.f2168id = z_T4JInternalParseUtil.getInt(DBFavorites.KEY_EVENT_ID, json);
    ...
    public int compareTo(UserList that) {
        return this.f2168id - that.getId();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UserList) || ((UserList) obj).getId() != this.f2168id) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "UserListJSONImpl{id=" + this.f2168id + ", name='" + this.name + '\'' + ", fullName='" + this.fullName + '\'' + ", slug='" + this.slug + '\'' + ", description='" + this.description + '\'' + ", subscriberCount=" + this.subscriberCount + ", memberCount=" + this.memberCount + ", uri='" + this.uri + '\'' + ", mode=" + this.mode + ", user=" + this.user + ", following=" + this.following + '}';
    }
}
