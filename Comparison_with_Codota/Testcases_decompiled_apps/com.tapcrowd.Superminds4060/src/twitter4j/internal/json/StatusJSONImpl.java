...
final class StatusJSONImpl extends TwitterResponseImpl implements Status, Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        this.f2166id = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, json);
        ...
        try {
            ...
            if (!json.isNull("current_user_retweet")) {
                this.currentUserRetweetId = json.getJSONObject("current_user_retweet").getLong(DBFavorites.KEY_EVENT_ID);
            }
    ...
    public int compareTo(Status that) {
        long delta = this.f2166id - that.getId();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Status) || ((Status) obj).getId() != this.f2166id) {
            return false;
        }
        return true;
    }
