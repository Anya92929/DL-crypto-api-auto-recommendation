...
final class UserJSONImpl extends TwitterResponseImpl implements User, Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        try {
            this.f2167id = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, json);
            this.name = z_T4JInternalParseUtil.getRawString(DBFavorites.KEY_NAME, json);
            ...
            this.descriptionURLEntities = getURLEntitiesFromJSON(json, PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION);
            this.descriptionURLEntities = this.descriptionURLEntities == null ? new URLEntity[0] : this.descriptionURLEntities;
            URLEntity[] urlEntities = getURLEntitiesFromJSON(json, PlusShare.KEY_CALL_TO_ACTION_URL);
            if (urlEntities != null && urlEntities.length > 0) {
                this.urlEntity = urlEntities[0];
            }
            this.description = z_T4JInternalParseUtil.getRawString(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, json);
            ...
            this.url = z_T4JInternalParseUtil.getRawString(PlusShare.KEY_CALL_TO_ACTION_URL, json);
    ...
    public int compareTo(User that) {
        return (int) (this.f2167id - that.getId());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof User) || ((User) obj).getId() != this.f2167id) {
            return false;
        }
        return true;
    }
