...
class FriendshipJSONImpl implements Friendship {
    ...
    FriendshipJSONImpl(JSONObject json) throws TwitterException {
        try {
            this.f2162id = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, json);
    ...
    public int hashCode() {
        ...
        int i3;
        int i4 = 1;
        int i5 = ((int) (this.f2162id ^ (this.f2162id >>> 32))) * 31;
        if (this.name != null) {
    ...
    public String toString() {
        return "FriendshipJSONImpl{id=" + this.f2162id + ", name='" + this.name + '\'' + ", screenName='" + this.screenName + '\'' + ", following=" + this.following + ", followedBy=" + this.followedBy + '}';
    }
}
