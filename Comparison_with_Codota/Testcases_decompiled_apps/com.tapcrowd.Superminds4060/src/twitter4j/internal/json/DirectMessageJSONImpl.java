...
final class DirectMessageJSONImpl extends TwitterResponseImpl implements DirectMessage, Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        this.f2161id = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, json);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DirectMessage) || ((DirectMessage) obj).getId() != this.f2161id) {
            return false;
        }
        return true;
    }
