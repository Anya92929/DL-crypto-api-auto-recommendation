...
final class PlaceJSONImpl extends TwitterResponseImpl implements Place, Serializable {
    ...
    private void init(JSONObject json) throws TwitterException {
        try {
            this.name = z_T4JInternalParseUtil.getUnescapedString(DBFavorites.KEY_NAME, json);
            ...
            this.f2164id = z_T4JInternalParseUtil.getRawString(DBFavorites.KEY_EVENT_ID, json);
            ...
            if (!json.isNull("place_type")) {
                ...
                this.placeType = z_T4JInternalParseUtil.getRawString(Globalization.TYPE, json);
            }
            ...
            if (!json.isNull("bounding_box")) {
                ...
                this.boundingBoxType = z_T4JInternalParseUtil.getRawString(Globalization.TYPE, boundingBoxJSON);
            ...
            if (!json.isNull("geometry")) {
                ...
                this.geometryType = z_T4JInternalParseUtil.getRawString(Globalization.TYPE, geometryJSON);
    ...
    public int compareTo(Place that) {
        return this.f2164id.compareTo(that.getId());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Place) || !((Place) obj).getId().equals(this.f2164id)) {
            return false;
        }
        return true;
    }
