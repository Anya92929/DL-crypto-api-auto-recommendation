...
final class SavedSearchJSONImpl extends TwitterResponseImpl implements SavedSearch {
    ...
    private void init(JSONObject savedSearch) throws TwitterException {
        ...
        this.name = z_T4JInternalParseUtil.getUnescapedString(DBFavorites.KEY_NAME, savedSearch);
        this.f2165id = z_T4JInternalParseUtil.getInt(DBFavorites.KEY_EVENT_ID, savedSearch);
    }

    public int compareTo(SavedSearch that) {
        return this.f2165id - that.getId();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.f2165id != ((SavedSearch) o).getId()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((this.createdAt.hashCode() * 31) + this.query.hashCode()) * 31) + this.position) * 31) + this.name.hashCode()) * 31) + this.f2165id;
    }

    public String toString() {
        return "SavedSearchJSONImpl{createdAt=" + this.createdAt + ", query='" + this.query + '\'' + ", position=" + this.position + ", name='" + this.name + '\'' + ", id=" + this.f2165id + '}';
    }
}
