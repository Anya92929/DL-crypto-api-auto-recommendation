...
class RelationshipJSONImpl extends TwitterResponseImpl implements Relationship, Serializable {
    ...
    RelationshipJSONImpl(HttpResponse res, JSONObject json) throws TwitterException {
        ...
        try {
            ...
            this.sourceUserId = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, sourceJson);
            this.targetUserId = z_T4JInternalParseUtil.getLong(DBFavorites.KEY_EVENT_ID, targetJson);
