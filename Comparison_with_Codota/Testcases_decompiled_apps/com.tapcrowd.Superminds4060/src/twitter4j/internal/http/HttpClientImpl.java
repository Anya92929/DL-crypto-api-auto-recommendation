...
public class HttpClientImpl extends HttpClientBase implements HttpResponseCode, Serializable {
            ...
            try {
                ...
                if (req.getMethod() == RequestMethod.POST) {
                    if (HttpParameter.containsFile(req.getParameters())) {
                        ...
                        con.setRequestProperty(MIME.CONTENT_TYPE, "multipart/form-data; boundary=" + boundary);
                        ...
                        con.setRequestProperty(MIME.CONTENT_TYPE, Request.DEFAULT_CONTENT_TYPE);
                ...
                try {
                    ...
                    if (responseCode >= 200 && (responseCode == 302 || 300 > responseCode)) {
                        ...
                        try {
                            ...
                            Thread.sleep((long) (this.CONF.getHttpRetryIntervalSeconds() * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE));
    ...
    private void setHeaders(HttpRequest req, HttpURLConnection connection) {
        ...
        if (logger.isDebugEnabled()) {
            ...
            logger.debug(req.getMethod().name() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, req.getURL());
        }
        if (!(req.getAuthorization() == null || (authorizationHeader = req.getAuthorization().getAuthorizationHeader(req)) == null)) {
            ...
            connection.addRequestProperty(OAuthConstants.HEADER, authorizationHeader);
        }
