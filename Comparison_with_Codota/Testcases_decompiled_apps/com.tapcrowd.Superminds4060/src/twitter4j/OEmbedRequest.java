...
public final class OEmbedRequest implements Serializable {
    ...
    public HttpParameter[] asHttpParameterArray() {
        ...
        appendParameter(DBFavorites.KEY_EVENT_ID, this.statusId, (List<HttpParameter>) params);
        appendParameter(PlusShare.KEY_CALL_TO_ACTION_URL, this.url, (List<HttpParameter>) params);
