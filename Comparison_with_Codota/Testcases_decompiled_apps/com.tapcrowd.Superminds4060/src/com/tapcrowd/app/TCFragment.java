...
public class TCFragment extends SherlockFragment {
    ...
    public void setAbTitle(String title2) {
        ActionBar ab = getSherlockActivity().getSupportActionBar();
        String color = Integer.toHexString(C1216LO.getLo(C1216LO.navigationColor));
        if (color.length() == 8) {
            color = color.substring(2);
        }
        ab.setTitle((CharSequence) Html.fromHtml("<font color='#" + color + "'>" + title2 + "</font>"));
    }
