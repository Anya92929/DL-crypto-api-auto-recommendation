...
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
    ...
    /* renamed from: X */
    private static final int f1980X = 128;

    /* renamed from: Y */
    private static final int f1981Y = 256;
    ...
    private class AnimatorEventListener implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (!((propertyBundle.mPropertyMask & ViewPropertyAnimatorHC.TRANSFORM_MASK) == 0 || (v = (View) ViewPropertyAnimatorHC.this.mView.get()) == null)) {
                v.invalidate();
            }
