...
public class AnimatorInflater {
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attrs, ValueAnimator anim) throws Resources.NotFoundException {
        ...
        if (getFloats) {
            if (hasFrom) {
                if (fromType == 5) {
                    valueFrom2 = a.getDimension(5, BitmapDescriptorFactory.HUE_RED);
                } else {
                    valueFrom2 = a.getFloat(5, BitmapDescriptorFactory.HUE_RED);
                }
                if (hasTo) {
                    if (toType == 5) {
                        valueTo4 = a.getDimension(6, BitmapDescriptorFactory.HUE_RED);
                    } else {
                        valueTo4 = a.getFloat(6, BitmapDescriptorFactory.HUE_RED);
                    }
                ...
                if (toType == 5) {
                    valueTo3 = a.getDimension(6, BitmapDescriptorFactory.HUE_RED);
                } else {
                    valueTo3 = a.getFloat(6, BitmapDescriptorFactory.HUE_RED);
                }
                anim.setFloatValues(valueTo3);
            }
        } else if (hasFrom) {
            if (fromType == 5) {
                valueFrom = (int) a.getDimension(5, BitmapDescriptorFactory.HUE_RED);
            ...
            if (hasTo) {
                if (toType == 5) {
                    valueTo2 = (int) a.getDimension(6, BitmapDescriptorFactory.HUE_RED);
            ...
            if (toType == 5) {
                valueTo = (int) a.getDimension(6, BitmapDescriptorFactory.HUE_RED);
            } else if (toType < 28 || toType > 31) {
