...
class KeyframeSet {
    ...
    public static KeyframeSet ofInt(int... values) {
        ...
        if (numKeyframes == 1) {
            keyframes[0] = (Keyframe.IntKeyframe) Keyframe.ofInt(BitmapDescriptorFactory.HUE_RED);
            keyframes[1] = (Keyframe.IntKeyframe) Keyframe.ofInt(1.0f, values[0]);
        } else {
            keyframes[0] = (Keyframe.IntKeyframe) Keyframe.ofInt(BitmapDescriptorFactory.HUE_RED, values[0]);
    ...
    public static KeyframeSet ofFloat(float... values) {
        ...
        if (numKeyframes == 1) {
            keyframes[0] = (Keyframe.FloatKeyframe) Keyframe.ofFloat(BitmapDescriptorFactory.HUE_RED);
            keyframes[1] = (Keyframe.FloatKeyframe) Keyframe.ofFloat(1.0f, values[0]);
        } else {
            keyframes[0] = (Keyframe.FloatKeyframe) Keyframe.ofFloat(BitmapDescriptorFactory.HUE_RED, values[0]);
            for (int i = 1; i < numKeyframes; i++) {
    ...
    public static KeyframeSet ofObject(Object... values) {
        ...
        if (numKeyframes == 1) {
            keyframes[0] = (Keyframe.ObjectKeyframe) Keyframe.ofObject(BitmapDescriptorFactory.HUE_RED);
            keyframes[1] = (Keyframe.ObjectKeyframe) Keyframe.ofObject(1.0f, values[0]);
        } else {
            keyframes[0] = (Keyframe.ObjectKeyframe) Keyframe.ofObject(BitmapDescriptorFactory.HUE_RED, values[0]);
            for (int i = 1; i < numKeyframes; i++) {
