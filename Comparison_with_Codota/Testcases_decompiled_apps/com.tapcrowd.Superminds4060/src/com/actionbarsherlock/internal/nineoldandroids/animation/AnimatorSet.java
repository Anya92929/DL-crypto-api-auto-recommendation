...
public final class AnimatorSet extends Animator {
    ...
    public ArrayList<Animator> getChildAnimations() {
        ...
        while (it.hasNext()) {
            childList.add(it.next().animation);
        }
        return childList;
    }
    ...
    public void setTarget(Object target) {
        Iterator<Node> it = this.mNodes.iterator();
        while (it.hasNext()) {
            Animator animation = it.next().animation;
    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (tmpListeners != null) {
                Iterator<Animator.AnimatorListener> it3 = tmpListeners.iterator();
                while (it3.hasNext()) {
                    it3.next().onAnimationEnd(this);
                }
            }
            this.mStarted = false;
        }
    ...
    public void end() {
        ...
        if (isStarted()) {
            ...
            if (this.mListeners != null) {
                Iterator<Animator.AnimatorListener> it3 = ((ArrayList) this.mListeners.clone()).iterator();
                while (it3.hasNext()) {
                    it3.next().onAnimationEnd(this);
                }
            }
    ...
    public void start() {
        ...
        for (int i = 0; i < numSortedNodes; i++) {
            ...
            if (oldListeners != null && oldListeners.size() > 0) {
                Iterator<Animator.AnimatorListener> it = new ArrayList<>(oldListeners).iterator();
                while (it.hasNext()) {
        ...
        if (this.mStartDelay <= 0) {
            Iterator<Node> it2 = nodesToStart.iterator();
            while (it2.hasNext()) {
                Node node3 = it2.next();
            ...
            this.mDelayAnim = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
    ...
    public AnimatorSet clone() {
        ...
        while (it.hasNext()) {
            ...
            if (cloneListeners != null) {
                ...
                Iterator<Animator.AnimatorListener> it2 = cloneListeners.iterator();
                while (it2.hasNext()) {
                    Animator.AnimatorListener listener = it2.next();
                ...
                if (listenersToRemove != null) {
                    Iterator<Animator.AnimatorListener> it3 = listenersToRemove.iterator();
                    while (it3.hasNext()) {
                        cloneListeners.remove(it3.next());
                    }
                }
            }
        }
        ...
        while (it4.hasNext()) {
            ...
            if (node2.dependencies != null) {
                Iterator<Dependency> it5 = node2.dependencies.iterator();
                while (it5.hasNext()) {
                    Dependency dependency = it5.next();
    ...
    public class Builder {
        ...
        public Builder after(long delay) {
            ValueAnimator anim = ValueAnimator.ofFloat(BitmapDescriptorFactory.HUE_RED, 1.0f);
