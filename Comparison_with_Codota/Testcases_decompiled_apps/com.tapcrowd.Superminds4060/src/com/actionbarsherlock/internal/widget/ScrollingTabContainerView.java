...
public class ScrollingTabContainerView extends NineHorizontalScrollView implements IcsAdapterView.OnItemSelectedListener {
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C0051R.styleable.SherlockActionBar, C0051R.attr.actionBarStyle, 0);
    ...
    private IcsLinearLayout createTabLayout() {
        IcsLinearLayout tabLayout = (IcsLinearLayout) LayoutInflater.from(getContext()).inflate(C0051R.layout.abs__action_bar_tab_bar_view, (ViewGroup) null);
        tabLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -1));
        return tabLayout;
    }

    private IcsSpinner createSpinner() {
        IcsSpinner spinner = new IcsSpinner(getContext(), (AttributeSet) null, C0051R.attr.actionDropDownStyle);
    ...
    public TabView createTabView(ActionBar.Tab tab, boolean forAdapter) {
        TabView tabView = (TabView) this.mInflater.inflate(C0051R.layout.abs__action_bar_tab, (ViewGroup) null);
    ...
    public static class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    CapitalizingTextView textView = new CapitalizingTextView(getContext(), (AttributeSet) null, C0051R.attr.actionBarTabTextStyle);
