...
public class ActionBarContextView extends AbsActionBarView implements Animator.AnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.SherlockActionMode, defStyle, 0);
    ...
    private void initTitle() {
        ...
        int i2 = 8;
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0051R.layout.abs__action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode mode) {
        if (this.mClose == null) {
            this.mClose = (NineLinearLayout) LayoutInflater.from(this.mContext).inflate(C0051R.layout.abs__action_mode_close_item, this, false);
            addView(this.mClose);
        } else if (this.mClose.getParent() == null) {
            addView(this.mClose);
        }
        this.mClose.findViewById(C0051R.C0052id.abs__action_mode_close_button).setOnClickListener(new View.OnClickListener() {
