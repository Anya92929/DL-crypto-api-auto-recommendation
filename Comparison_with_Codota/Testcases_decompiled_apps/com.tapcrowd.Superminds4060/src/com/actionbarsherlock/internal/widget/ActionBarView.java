...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.SherlockActionBar, C0051R.attr.actionBarStyle, 0);
        ...
        if (this.mLogo == null) {
            ...
            } else if ((context instanceof Activity) && (resId = loadLogoFromManifest((Activity) context)) != 0) {
        ...
        int homeResId = a.getResourceId(14, C0051R.layout.abs__action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0051R.string.abs__action_bar_up_description));
                ...
                if (eventType == 2) {
                    ...
                    if ("application".equals(name)) {
                        ...
                        while (true) {
                            if (i < 0) {
                                break;
                            } else if ("logo".equals(xml.getAttributeName(i))) {
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0051R.C0052id.abs__progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0051R.C0052id.abs__progress_circular);
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        ...
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0051R.C0052id.abs__action_menu_presenter);
            ...
            if (!this.mSplitActionBar) {
                this.mActionMenuPresenter.setExpandedActionViewsExclusive(ResourcesCompat.getResources_getBoolean(getContext(), C0051R.bool.abs__action_bar_expanded_action_views_exclusive));
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0051R.string.abs__action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0051R.string.abs__action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case 1:
                    if (this.mSpinner == null) {
                        this.mSpinner = new IcsSpinner(this.mContext, (AttributeSet) null, C0051R.attr.actionDropDownStyle);
                        this.mListNavLayout = (IcsLinearLayout) LayoutInflater.from(this.mContext).inflate(C0051R.layout.abs__action_bar_tab_bar_view, (ViewGroup) null);
    ...
    public void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0051R.layout.abs__action_bar_title_item, this, DEBUG);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0051R.C0052id.abs__action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0051R.C0052id.abs__action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0051R.C0052id.abs__up);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            boolean showTitle = (this.mTitleLayout == null || this.mTitleLayout.getVisibility() == 8 || (this.mDisplayOptions & 8) == 0) ? DEBUG : true;
    ...
    public static class HomeView extends FrameLayout {
        ...
        /* access modifiers changed from: protected */
        public void onFinishInflate() {
            this.mUpView = findViewById(C0051R.C0052id.abs__up);
            this.mIconView = (ImageView) findViewById(C0051R.C0052id.abs__home);
        }
