...
public class ActionBarContainer extends NineFrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.SherlockActionBar);
        this.mBackground = a.getDrawable(2);
        this.mStackedBackground = a.getDrawable(12);
        if (getId() == C0051R.C0052id.abs__split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = (ActionBarView) findViewById(C0051R.C0052id.abs__action_bar);
    }
