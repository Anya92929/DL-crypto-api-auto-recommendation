...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0051R.layout.abs__action_menu_layout, C0051R.layout.abs__action_menu_item_layout);
    }
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(context, C0051R.integer.abs__max_action_buttons);
        }
    ...
    public static boolean reserveOverflow(Context context) {
        boolean z = false;
        TypedArray a = context.getTheme().obtainStyledAttributes(C0051R.styleable.SherlockTheme);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = ResourcesCompat.getResources_getInteger(this.mContext, C0051R.integer.abs__max_action_buttons);
            if (this.mMenu != null) {
