...
public class ActionMenuItemView extends LinearLayout implements MenuView.ItemView, View.OnClickListener, View.OnLongClickListener, ActionMenuView.ActionMenuChildView, View_HasStateListenerSupport {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = ResourcesCompat.getResources_getBoolean(context, C0051R.bool.abs__config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0051R.styleable.SherlockActionMenuItemView, 0, 0);
    ...
    public void onFinishInflate() {
        this.mImageButton = (ImageButton) findViewById(C0051R.C0052id.abs__imageButton);
        this.mTextButton = (CapitalizingButton) findViewById(C0051R.C0052id.abs__textButton);
