...
public class MenuBuilder implements Menu {
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        if (!shortcutsVisible || this.mResources.getConfiguration().keyboard == 1 || !this.mResources.getBoolean(C0051R.bool.abs__config_showMenuShortcutsWhenKeyboardPresent)) {
            z = false;
        }
