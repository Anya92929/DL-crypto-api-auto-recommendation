...
public final class AdSize {
    ...
    public static final AdSize IAB_MRECT = new AdSize(HttpResponseCode.MULTIPLE_CHOICES, 250, "as");
    ...
    /* renamed from: c */
    private final com.google.android.gms.ads.AdSize f278c;
    ...
    public boolean equals(Object other) {
        ...
        return this.f278c.equals(((AdSize) other).f278c);
    }
    ...
    public int getHeight() {
        return this.f278c.getHeight();
    }

    public int getHeightInPixels(Context context) {
        return this.f278c.getHeightInPixels(context);
    }

    public int getWidth() {
        return this.f278c.getWidth();
    }

    public int getWidthInPixels(Context context) {
        return this.f278c.getWidthInPixels(context);
    }
    ...
    public boolean isAutoHeight() {
        return this.f278c.isAutoHeight();
    }
