...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class C0653a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a$a */
        private static class C0654a implements ILocationSourceDelegate {

            /* renamed from: dG */
            private IBinder f1678dG;

            C0654a(IBinder iBinder) {
                this.f1678dG = iBinder;
            }

            public void activate(C0679g listener) throws RemoteException {
                ...
                try {
                    ...
                    this.f1678dG.transact(1, obtain, obtain2, 0);
            ...
            public void deactivate() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ILocationSourceDelegate");
                    this.f1678dG.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: M */
        public static ILocationSourceDelegate m2013M(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ILocationSourceDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0654a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(C0679g.C0680a.m2044R(data.readStrongBinder()));
    ...
    void activate(C0679g gVar) throws RemoteException;
