...
public interface C0503ew extends IInterface {

    /* renamed from: com.google.android.gms.internal.ew$a */
    public static abstract class C0504a extends Binder implements C0503ew {

        /* renamed from: com.google.android.gms.internal.ew$a$a */
        private static class C0505a implements C0503ew {

            /* renamed from: dG */
            private IBinder f1277dG;

            C0505a(IBinder iBinder) {
                this.f1277dG = iBinder;
            }
            ...
            public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) throws RemoteException {
                ...
                try {
                    ...
                    this.f1277dG.transact(1, obtain, obtain2, 0);
            ...
            public void onRemoveGeofencesByPendingIntentResult(int statusCode, PendingIntent pendingIntent) throws RemoteException {
                ...
                try {
                    ...
                    this.f1277dG.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(statusCode);
                    obtain.writeStringArray(geofenceRequestIds);
                    this.f1277dG.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: E */
        public static C0503ew m1489E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0503ew)) ? new C0505a(iBinder) : (C0503ew) queryLocalInterface;
        }
