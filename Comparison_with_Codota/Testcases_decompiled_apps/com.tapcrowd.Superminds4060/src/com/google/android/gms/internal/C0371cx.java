...
public interface C0371cx extends IInterface {

    /* renamed from: com.google.android.gms.internal.cx$a */
    public static abstract class C0372a extends Binder implements C0371cx {

        /* renamed from: com.google.android.gms.internal.cx$a$a */
        private static class C0373a implements C0371cx {

            /* renamed from: dG */
            private IBinder f1064dG;

            C0373a(IBinder iBinder) {
                this.f1064dG = iBinder;
            }

            /* renamed from: a */
            public void mo4254a(int i, C0140d dVar) throws RemoteException {
                ...
                try {
                    ...
                    this.f1064dG.transact(5001, obtain, obtain2, 0);
            ...
            /* renamed from: a */
            public void mo4255a(C0140d dVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateCallbacks");
                    ...
                    this.f1064dG.transact(5002, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            /* renamed from: m */
            public void mo4256m(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateCallbacks");
                    obtain.writeInt(i);
                    this.f1064dG.transact(5005, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSignOutComplete() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateCallbacks");
                    this.f1064dG.transact(5004, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onStateDeleted(int statusCode, int stateKey) throws RemoteException {
                ...
                try {
                    ...
                    this.f1064dG.transact(5003, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: s */
        public static C0371cx m801s(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.appstate.internal.IAppStateCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0371cx)) ? new C0373a(iBinder) : (C0371cx) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 5001:
                    ...
                    if (data.readInt() != 0) {
                        dVar = C0140d.CREATOR.createFromParcel(data);
                    }
                    mo4254a(readInt, dVar);
    ...
    /* renamed from: a */
    void mo4254a(int i, C0140d dVar) throws RemoteException;

    /* renamed from: a */
    void mo4255a(C0140d dVar) throws RemoteException;

    /* renamed from: m */
    void mo4256m(int i) throws RemoteException;
