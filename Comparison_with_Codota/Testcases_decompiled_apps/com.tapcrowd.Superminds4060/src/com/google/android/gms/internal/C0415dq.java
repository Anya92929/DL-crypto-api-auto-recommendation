...
public class C0415dq<K, V> {

    /* renamed from: lm */
    private final LinkedHashMap<K, V> f1138lm;
    ...
    public C0415dq(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException("maxSize <= 0");
        }
        this.f1139ln = i;
        this.f1138lm = new LinkedHashMap<>(0, 0.75f, true);
    }

    /* renamed from: b */
    private int m959b(K k, V v) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
        r4.f1141lp++;
        r0 = r4.f1138lm.put(r5, r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x003a, code lost:
        if (r0 == null) goto L_0x0049;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x003c, code lost:
        r4.f1138lm.put(r5, r0);
     */
    ...
    public final V get(K r5) {
        ...
        L_0x000a:
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.f1138lm     // Catch:{ all -> 0x002a }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x002a }
            if (r0 == 0) goto L_0x001b
            int r1 = r4.f1143lr     // Catch:{ all -> 0x002a }
            int r1 = r1 + 1
            r4.f1143lr = r1     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        L_0x001a:
            return r0
        L_0x001b:
            int r0 = r4.f1144ls     // Catch:{ all -> 0x002a }
            int r0 = r0 + 1
            r4.f1144ls = r0     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        ...
        L_0x002d:
            monitor-enter(r4)
            int r0 = r4.f1141lp     // Catch:{ all -> 0x0053 }
            int r0 = r0 + 1
            r4.f1141lp = r0     // Catch:{ all -> 0x0053 }
            java.util.LinkedHashMap<K, V> r0 = r4.f1138lm     // Catch:{ all -> 0x0053 }
            java.lang.Object r0 = r0.put(r5, r1)     // Catch:{ all -> 0x0053 }
            if (r0 == 0) goto L_0x0049
            java.util.LinkedHashMap<K, V> r2 = r4.f1138lm     // Catch:{ all -> 0x0053 }
        ...
        L_0x0049:
            ...
            int r3 = r4.m959b(r5, r1)     // Catch:{ all -> 0x0053 }
            int r2 = r2 + r3
        ...
        L_0x0056:
            ...
            goto L_0x001a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.C0415dq.get(java.lang.Object):java.lang.Object");
    }
    ...
    public final V put(K key, V value) {
        ...
        synchronized (this) {
            this.f1140lo++;
            this.size += m959b(key, value);
            put = this.f1138lm.put(key, value);
            if (put != null) {
                this.size -= m959b(key, put);
            }
        }
        if (put != null) {
            entryRemoved(false, key, put, value);
        }
        trimToSize(this.f1139ln);
        return put;
    }
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.f1143lr + this.f1144ls;
            if (i2 != 0) {
                i = (this.f1143lr * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.f1139ln), Integer.valueOf(this.f1143lr), Integer.valueOf(this.f1144ls), Integer.valueOf(i)});
        }
        return format;
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0000:
            ...
            java.util.LinkedHashMap<K, V> r0 = r4.f1138lm     // Catch:{ all -> 0x0032 }
        ...
        L_0x0043:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.f1138lm     // Catch:{ all -> 0x0032 }
            r2.remove(r1)     // Catch:{ all -> 0x0032 }
            int r2 = r4.size     // Catch:{ all -> 0x0032 }
            int r3 = r4.m959b(r1, r0)     // Catch:{ all -> 0x0032 }
            int r2 = r2 - r3
            r4.size = r2     // Catch:{ all -> 0x0032 }
            int r2 = r4.f1142lq     // Catch:{ all -> 0x0032 }
            int r2 = r2 + 1
            r4.f1142lq = r2     // Catch:{ all -> 0x0032 }
            monitor-exit(r4)     // Catch:{ all -> 0x0032 }
            r2 = 1
            r3 = 0
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.C0415dq.trimToSize(int):void");
    }
}
