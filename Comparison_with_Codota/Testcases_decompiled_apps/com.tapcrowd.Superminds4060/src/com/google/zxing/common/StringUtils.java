...
public final class StringUtils {
    private static final boolean ASSUME_SHIFT_JIS = ((SHIFT_JIS.equalsIgnoreCase(PLATFORM_DEFAULT_ENCODING) || EUC_JP.equalsIgnoreCase(PLATFORM_DEFAULT_ENCODING)) ? true : ASSUME_SHIFT_JIS);
    ...
    public static String guessEncoding(byte[] bytes, Map<DecodeHintType, ?> hints) {
        ...
        int isoHighOther = 0;
        boolean utf8bom = (bytes.length > 3 && bytes[0] == -17 && bytes[1] == -69 && bytes[2] == -65) ? true : ASSUME_SHIFT_JIS;
