...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f1957FS = '\u001c';

    /* renamed from: GS */
    private static final char f1958GS = '\u001d';
    ...
    /* renamed from: NS */
    private static final char f1959NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f1960RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f1958GS + country + f1958GS + service + f1958GS);
                    break;
                } else {
                    result.insert(9, postcode + f1958GS + country + f1958GS + service + f1958GS);
                    break;
                }
            case 4:
