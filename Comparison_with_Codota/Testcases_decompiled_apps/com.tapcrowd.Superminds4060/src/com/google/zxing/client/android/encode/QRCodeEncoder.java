    ...
    private boolean encodeContentsFromZXingIntent(Intent intent) {
        ...
        if (this.format == null || this.format == BarcodeFormat.QR_CODE) {
            ...
            if (data != null && !data.isEmpty()) {
                ...
                this.title = this.activity.getString(C0776R.string.contents_text);
            }
        }
    ...
    private void encodeQRCodeContents(Intent intent, String type) {
        ...
        if (type.equals(Contents.Type.TEXT)) {
            ...
            if (data2 != null) {
                ...
                this.title = this.activity.getString(C0776R.string.contents_email);
            }
            ...
            if (data3 != null) {
                ...
                this.title = this.activity.getString(C0776R.string.contents_phone);
            }
            ...
            if (data4 != null) {
                ...
                this.title = this.activity.getString(C0776R.string.contents_sms);
            }
        } else if (type.equals(Contents.Type.CONTACT)) {
            Bundle bundle2 = intent.getBundleExtra(Intents.Encode.DATA);
            if (bundle2 != null) {
                String name = bundle2.getString(DBFavorites.KEY_NAME);
                ...
                if (!encoded[1].isEmpty()) {
                    ...
                    this.title = this.activity.getString(C0776R.string.contents_contact);
                }
            }
            ...
            if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
                ...
                this.title = this.activity.getString(C0776R.string.contents_location);
            }
        }
    }
