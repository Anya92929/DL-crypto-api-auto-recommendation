...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        this.maskColor = resources.getColor(C0776R.color.viewfinder_mask);
        this.resultColor = resources.getColor(C0776R.color.result_view);
        this.laserColor = resources.getColor(C0776R.color.viewfinder_laser);
        this.resultPointColor = resources.getColor(C0776R.color.possible_result_points);
        this.scannerAlpha = 0;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.cameraManager != null) {
            ...
            if (frame != null && previewFrame != null) {
                ...
                paint2.setColor(i);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) width, (float) frame.top, this.paint);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, (float) frame.top, (float) frame.left, (float) (frame.bottom + 1), this.paint);
                canvas.drawRect((float) (frame.right + 1), (float) frame.top, (float) width, (float) (frame.bottom + 1), this.paint);
                canvas.drawRect(BitmapDescriptorFactory.HUE_RED, (float) (frame.bottom + 1), (float) width, (float) height, this.paint);
                if (this.resultBitmap != null) {
