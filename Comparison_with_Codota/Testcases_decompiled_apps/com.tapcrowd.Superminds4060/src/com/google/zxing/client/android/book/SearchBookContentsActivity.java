...
public final class SearchBookContentsActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (LocaleManager.isBookSearchUrl(this.isbn)) {
            setTitle(getString(C0776R.string.sbc_name));
        } else {
            setTitle(String.valueOf(getString(C0776R.string.sbc_name)) + ": ISBN " + this.isbn);
        }
        setContentView(C0776R.layout.search_book_contents);
        this.queryTextView = (EditText) findViewById(C0776R.C0777id.query_text_view);
        String initialQuery = intent.getStringExtra(Intents.SearchBookContents.QUERY);
        if (initialQuery != null && !initialQuery.isEmpty()) {
            this.queryTextView.setText(initialQuery);
        }
        this.queryTextView.setOnKeyListener(this.keyListener);
        this.queryButton = (Button) findViewById(C0776R.C0777id.query_button);
        this.queryButton.setOnClickListener(this.buttonListener);
        this.resultListView = (ListView) findViewById(C0776R.C0777id.result_list_view);
        this.headerView = (TextView) LayoutInflater.from(this).inflate(C0776R.layout.search_book_contents_header, this.resultListView, false);
    ...
    public void launchSearch() {
        ...
        if (query != null && !query.isEmpty()) {
            ...
            this.headerView.setText(C0776R.string.msg_sbc_searching_book);
    ...
    private final class NetworkTask extends AsyncTask<String, Object, JSONObject> {
        ...
        public void onPostExecute(JSONObject result) {
            if (result == null) {
                SearchBookContentsActivity.this.headerView.setText(C0776R.string.msg_sbc_failed);
            } else {
        ...
        private void handleSearchResults(JSONObject json) {
            try {
                ...
                SearchBookContentsActivity.this.headerView.setText(String.valueOf(SearchBookContentsActivity.this.getString(C0776R.string.msg_sbc_results)) + " : " + count);
                if (count > 0) {
                ...
                if ("false".equals(json.optString("searchable"))) {
                    SearchBookContentsActivity.this.headerView.setText(C0776R.string.msg_sbc_book_not_searchable);
                }
        ...
        private SearchBookContentsResult parseResult(JSONObject json) {
            ...
            try {
                ...
                if (pageNumber2 == null || pageNumber2.isEmpty()) {
                    ...
                    pageNumber = String.valueOf(SearchBookContentsActivity.this.getString(C0776R.string.msg_sbc_page)) + ' ' + pageNumber2;
                }
                ...
                if (valid) {
                    ...
                    snippet = String.valueOf('(') + SearchBookContentsActivity.this.getString(C0776R.string.msg_sbc_snippet_unavailable) + ')';
                }
                return new SearchBookContentsResult(pageId, pageNumber, snippet, valid);
            } catch (JSONException e) {
                Log.w(SearchBookContentsActivity.TAG, e);
                return new SearchBookContentsResult(SearchBookContentsActivity.this.getString(C0776R.string.msg_sbc_no_page_returned), "", "", false);
            }
        }
    }
}
