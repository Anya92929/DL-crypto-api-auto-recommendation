    ...
    public static void maybeInvokeRetrieval(TextView textView, ParsedResult result, HistoryManager historyManager, Context context) {
        ...
        if (result instanceof URIParsedResult) {
            ...
            switch (productID.length()) {
                case 12:
                    taskExec.execute(new AmazonInfoRetriever(textView, "UPC", normalizedProductID, historyManager, context), new Object[0]);
                    return;
                case 13:
                    taskExec.execute(new AmazonInfoRetriever(textView, "EAN", normalizedProductID, historyManager, context), new Object[0]);
                    return;
                default:
                    return;
            }
