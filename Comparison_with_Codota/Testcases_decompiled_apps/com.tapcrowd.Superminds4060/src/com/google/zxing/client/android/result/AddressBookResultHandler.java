...
public final class AddressBookResultHandler extends ResultHandler {
    private static final int[] BUTTON_TEXTS = {C0776R.string.button_add_contact, C0776R.string.button_show_map, C0776R.string.button_dial, C0776R.string.button_email};
    ...
    public int getDisplayTitle() {
        return C0776R.string.result_address_book;
    }
}
