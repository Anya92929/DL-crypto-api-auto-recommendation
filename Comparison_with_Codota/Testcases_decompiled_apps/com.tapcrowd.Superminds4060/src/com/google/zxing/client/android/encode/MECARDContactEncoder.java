...
final class MECARDContactEncoder extends ContactEncoder {
    ...
    public String[] encode(Iterable<String> names, String organization, Iterable<String> addresses, Iterable<String> phones, Iterable<String> emails, Iterable<String> urls, String note) {
        ...
        appendUpToUnique(newContents, newDisplayContents, "EMAIL", emails, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, (Formatter) null);
        appendUpToUnique(newContents, newDisplayContents, "URL", urls, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, (Formatter) null);
