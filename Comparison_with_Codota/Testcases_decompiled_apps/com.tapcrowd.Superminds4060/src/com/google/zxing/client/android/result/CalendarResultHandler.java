...
public final class CalendarResultHandler extends ResultHandler {
    ...
    private static final int[] buttons = {C0776R.string.button_add_calendar};
    ...
    private void addCalendarEvent(String summary, Date start, boolean allDay, Date end, String location, String description, String[] attendees) {
        ...
        intent.putExtra(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_TITLE, summary);
    ...
    public int getDisplayTitle() {
        return C0776R.string.result_calendar;
    }
}
