...
public abstract class ResultHandler {
    ...
    ResultHandler(Activity activity2, ParsedResult result2, Result rawResult2) {
        ...
        activity2.findViewById(C0776R.C0777id.shopper_button).setVisibility(8);
    }
    ...
    public final void showGoogleShopperButton(View.OnClickListener listener) {
        View shopperButton = this.activity.findViewById(C0776R.C0777id.shopper_button);
    ...
    public final void addContact(String[] names, String[] nicknames, String pronunciation, String[] phoneNumbers, String[] phoneTypes, String[] emails, String[] emailTypes, String note, String instantMessenger, String address, String addressType, String org2, String title, String[] urls, String birthday, String[] geo) {
        ...
        putExtra(intent, DBFavorites.KEY_NAME, names != null ? names[0] : null);
    ...
    public final void shareByEmail(String contents) {
        sendEmailFromUri("mailto:", (String) null, this.activity.getString(C0776R.string.msg_share_subject_line), contents);
    }
    ...
    public final void shareBySMS(String contents) {
        sendSMSFromUri("smsto:", String.valueOf(this.activity.getString(C0776R.string.msg_share_subject_line)) + ":\n" + contents);
    }
    ...
    public final void sendMMSFromUri(String uri, String subject, String body) {
        ...
        if (subject == null || subject.isEmpty()) {
            putExtra(intent, "subject", this.activity.getString(C0776R.string.msg_default_mms_subject));
        } else {
    ...
    public final void openGoogleShopper(String query) {
        ...
        intent.putExtra("query", query);
        Collection<?> availableApps = this.activity.getPackageManager().queryIntentActivities(intent, 65536);
        if (availableApps == null || availableApps.isEmpty()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this.activity);
            builder.setTitle(C0776R.string.msg_google_shopper_missing);
            builder.setMessage(C0776R.string.msg_install_google_shopper);
            builder.setIcon(C0776R.drawable.shopper_icon);
            builder.setPositiveButton(C0776R.string.button_ok, this.shopperMarketListener);
            builder.setNegativeButton(C0776R.string.button_cancel, (DialogInterface.OnClickListener) null);
            builder.show();
            return;
        }
    ...
    public final void launchIntent(Intent intent) {
        try {
            ...
            builder.setMessage(C0776R.string.msg_intent_failed);
