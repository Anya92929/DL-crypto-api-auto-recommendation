...
public final class HttpHelper {
    ...
    /* renamed from: $SWITCH_TABLE$com$google$zxing$client$android$HttpHelper$ContentType */
    private static /* synthetic */ int[] f1953x217be168;
    ...
    /* renamed from: $SWITCH_TABLE$com$google$zxing$client$android$HttpHelper$ContentType */
    static /* synthetic */ int[] m2199x217be168() {
        int[] iArr = f1953x217be168;
        if (iArr == null) {
    ...
    public static CharSequence downloadViaHttp(String uri, ContentType type) throws IOException {
        return downloadViaHttp(uri, type, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }

    public static CharSequence downloadViaHttp(String uri, ContentType type, int maxChars) throws IOException {
        String contentTypes;
        switch (m2199x217be168()[type.ordinal()]) {
            case 1:
    ...
    private static CharSequence downloadViaHttp(String uri, String contentTypes, int maxChars) throws IOException {
        ...
        while (redirects < 5) {
            ...
            try {
                ...
                switch (responseCode) {
                    case HttpResponseCode.f2160OK /*200*/:
    ...
    private static String getEncoding(URLConnection connection) {
        int charsetStart;
        String contentTypeHeader = connection.getHeaderField(MIME.CONTENT_TYPE);
