...
public final class CameraManager {
        ...
        synchronized (this) {
            if (this.framingRectInPreview == null) {
                ...
                if (framingRect2 != null) {
                    ...
                    this.framingViewSize = this.configManager.getScreenResolution();
                    if (!(cameraResolution == null || this.framingViewSize == null)) {
                        if (this.context.getResources().getConfiguration().orientation == 2) {
                            rect2.left = (rect2.left * cameraResolution.x) / this.framingViewSize.x;
                            rect2.right = (rect2.right * cameraResolution.x) / this.framingViewSize.x;
                            rect2.top = (rect2.top * cameraResolution.y) / this.framingViewSize.y;
                            rect2.bottom = (rect2.bottom * cameraResolution.y) / this.framingViewSize.y;
                        } else {
    ...
    public void setFramingViewSize(Point framingViewSize2) {
        this.framingViewSize = framingViewSize2;
    }
