...
public final class Detector {
    ...
    private boolean isValid(ResultPoint p) {
        return p.getX() >= BitmapDescriptorFactory.HUE_RED && p.getX() < ((float) this.image.getWidth()) && p.getY() > BitmapDescriptorFactory.HUE_RED && p.getY() < ((float) this.image.getHeight());
    }
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f1956to;
        ...
        public String toString() {
            return this.from + "/" + this.f1956to + '/' + this.transitions;
        }
    }
