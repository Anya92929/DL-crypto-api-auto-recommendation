...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{HttpResponseCode.MULTIPLE_CHOICES, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{HttpResponseCode.BAD_REQUEST, 440}, "DE");
            ...
            add(new int[]{HttpResponseCode.INTERNAL_SERVER_ERROR, 509}, "GB");
            add(new int[]{520}, "GR");
