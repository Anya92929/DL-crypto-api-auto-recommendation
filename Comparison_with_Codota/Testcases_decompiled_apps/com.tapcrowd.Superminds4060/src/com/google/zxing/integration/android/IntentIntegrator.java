...
public class IntentIntegrator {
    ...
    public static final Collection<String> ONE_D_CODE_TYPES = list("UPC_A", "UPC_E", "EAN_8", "EAN_13", "CODE_39", "CODE_93", "CODE_128", "ITF", "RSS_14", "RSS_EXPANDED", com.tapcrowd.app.utils.IntentIntegrator.QR_CODE_TYPES);
    public static final Collection<String> PRODUCT_CODE_TYPES = list("UPC_A", "UPC_E", "EAN_8", "EAN_13", "RSS_14");
    public static final Collection<String> QR_CODE_TYPES = Collections.singleton(com.tapcrowd.app.utils.IntentIntegrator.QR_CODE_TYPES);
