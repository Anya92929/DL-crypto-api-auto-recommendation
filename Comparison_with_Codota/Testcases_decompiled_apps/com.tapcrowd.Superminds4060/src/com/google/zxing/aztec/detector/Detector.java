...
public final class Detector {
    ...
    private ResultPoint[] getMatrixCornerPoints(Point[] bullEyeCornerPoints) throws NotFoundException {
        ...
        int dx = bullEyeCornerPoints[0].f1951x - bullEyeCornerPoints[2].f1951x;
        int dx2 = dx + (dx > 0 ? 1 : -1);
        int dy = bullEyeCornerPoints[0].f1952y - bullEyeCornerPoints[2].f1952y;
        int dy2 = dy + (dy > 0 ? 1 : -1);
        int targetcx = MathUtils.round(((float) bullEyeCornerPoints[2].f1951x) - (((float) dx2) * ratio));
        int targetcy = MathUtils.round(((float) bullEyeCornerPoints[2].f1952y) - (((float) dy2) * ratio));
        int targetax = MathUtils.round(((float) bullEyeCornerPoints[0].f1951x) + (((float) dx2) * ratio));
        int targetay = MathUtils.round(((float) bullEyeCornerPoints[0].f1952y) + (((float) dy2) * ratio));
        int dx3 = bullEyeCornerPoints[1].f1951x - bullEyeCornerPoints[3].f1951x;
        int dx4 = dx3 + (dx3 > 0 ? 1 : -1);
        int dy3 = bullEyeCornerPoints[1].f1952y - bullEyeCornerPoints[3].f1952y;
        int dy4 = dy3 + (dy3 > 0 ? 1 : -1);
        int targetdx = MathUtils.round(((float) bullEyeCornerPoints[3].f1951x) - (((float) dx4) * ratio));
        int targetdy = MathUtils.round(((float) bullEyeCornerPoints[3].f1952y) - (((float) dy4) * ratio));
        int targetbx = MathUtils.round(((float) bullEyeCornerPoints[1].f1951x) + (((float) dx4) * ratio));
        int targetby = MathUtils.round(((float) bullEyeCornerPoints[1].f1952y) + (((float) dy4) * ratio));
    ...
    private Point[] getBullEyeCornerPoints(Point pCenter) throws NotFoundException {
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            int dx = pina.f1951x - pinc.f1951x;
            int dy = pina.f1952y - pinc.f1952y;
            int targetcx = MathUtils.round(((float) pinc.f1951x) - (((float) dx) * ratio));
            int targetcy = MathUtils.round(((float) pinc.f1952y) - (((float) dy) * ratio));
            int targetax = MathUtils.round(((float) pina.f1951x) + (((float) dx) * ratio));
            int targetay = MathUtils.round(((float) pina.f1952y) + (((float) dy) * ratio));
            int dx2 = pinb.f1951x - pind.f1951x;
            int dy2 = pinb.f1952y - pind.f1952y;
            int targetdx = MathUtils.round(((float) pind.f1951x) - (((float) dx2) * ratio));
            int targetdy = MathUtils.round(((float) pind.f1952y) - (((float) dy2) * ratio));
            int targetbx = MathUtils.round(((float) pinb.f1951x) + (((float) dx2) * ratio));
            int targetby = MathUtils.round(((float) pinb.f1952y) + (((float) dy2) * ratio));
            if (!isValid(targetax, targetay) || !isValid(targetbx, targetby) || !isValid(targetcx, targetcy) || !isValid(targetdx, targetdy)) {
                throw NotFoundException.getNotFoundInstance();
            }
    ...
    private boolean[] sampleLine(Point p1, Point p2, int size) {
        ...
        float dx = (((float) (p2.f1951x - p1.f1951x)) * moduleSize) / d;
        float dy = (((float) (p2.f1952y - p1.f1952y)) * moduleSize) / d;
        float px = (float) p1.f1951x;
        float py = (float) p1.f1952y;
    ...
    private boolean isWhiteOrBlackRectangle(Point p1, Point p2, Point p3, Point p4) {
        Point p12 = new Point(p1.f1951x - 3, p1.f1952y + 3);
        Point p22 = new Point(p2.f1951x - 3, p2.f1952y - 3);
        Point p32 = new Point(p3.f1951x + 3, p3.f1952y - 3);
        Point p42 = new Point(p4.f1951x + 3, p4.f1952y + 3);
    ...
    private int getColor(Point p1, Point p2) {
        float d = distance(p1, p2);
        float dx = ((float) (p2.f1951x - p1.f1951x)) / d;
        float dy = ((float) (p2.f1952y - p1.f1952y)) / d;
        int error = 0;
        float px = (float) p1.f1951x;
        float py = (float) p1.f1952y;
        boolean colorModel = this.image.get(p1.f1951x, p1.f1952y);
    ...
    private Point getFirstDifferent(Point init, boolean color, int dx, int dy) {
        int x = init.f1951x + dx;
        int y = init.f1952y + dy;
    ...
    private static float distance(Point a, Point b) {
        return MathUtils.distance(a.f1951x, a.f1952y, b.f1951x, b.f1952y);
    }
    ...
    static final class Point {
        ...
        public ResultPoint toResultPoint() {
            return new ResultPoint((float) this.f1951x, (float) this.f1952y);
        }
