...
public class FinderPatternFinder {
    ...
    private boolean haveMultiplyConfirmedCenters() {
        ...
        float totalModuleSize = BitmapDescriptorFactory.HUE_RED;
        ...
        float totalDeviation = BitmapDescriptorFactory.HUE_RED;
    ...
    private FinderPattern[] selectBestPatterns() throws NotFoundException {
        ...
        if (startSize > 3) {
            float totalModuleSize = BitmapDescriptorFactory.HUE_RED;
            float square = BitmapDescriptorFactory.HUE_RED;
            for (FinderPattern center : this.possibleCenters) {
        ...
        if (this.possibleCenters.size() > 3) {
            float totalModuleSize2 = BitmapDescriptorFactory.HUE_RED;
