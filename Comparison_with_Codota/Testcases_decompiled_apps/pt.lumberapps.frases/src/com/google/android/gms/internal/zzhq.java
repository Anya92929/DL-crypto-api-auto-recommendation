...
public interface zzhq extends IInterface {
    ...
    public abstract class zza extends Binder implements zzhq {
        public static zzhq zzaw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhq)) ? new C1675jx(iBinder) : (zzhq) queryLocalInterface;
        }
