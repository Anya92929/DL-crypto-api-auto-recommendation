...
public interface zzdo extends IInterface {
    ...
    public abstract class zza extends Binder implements zzdo {
        public zza() {
        ...
        public static zzdo zzx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdo)) ? new C1537eu(iBinder) : (zzdo) queryLocalInterface;
        }
