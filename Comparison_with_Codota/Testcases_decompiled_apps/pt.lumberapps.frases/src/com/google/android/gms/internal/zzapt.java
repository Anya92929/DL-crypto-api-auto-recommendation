...
public final class zzapt {
    ...
    /* renamed from: a */
    protected static final Charset f5904a = Charset.forName("UTF-8");

    /* renamed from: b */
    protected static final Charset f5905b = Charset.forName("ISO-8859-1");
    ...
    public static void zza(zzapp zzapp, zzapp zzapp2) {
        if (zzapp.f5895a != null) {
            zzapp2.f5895a = (zzapr) zzapp.f5895a.clone();
        }
    }
