...
public interface zzcb extends IInterface {
    ...
    public abstract class zza extends Binder implements zzcb {
        public static zzcb zze(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.adshield.internal.IAdShieldCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcb)) ? new C1507dr(iBinder) : (zzcb) queryLocalInterface;
        }
