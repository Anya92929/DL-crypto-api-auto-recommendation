...
public interface zzdv extends IInterface {
    ...
    public abstract class zza extends Binder implements zzdv {
        public zza() {
        ...
        public static zzdv zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdv)) ? new C1541ey(iBinder) : (zzdv) queryLocalInterface;
        }
