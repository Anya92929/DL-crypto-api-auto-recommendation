...
public class ActionBarDrawerToggle implements C0423x {
    ...
    class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            boolean z = C0247by.m909d(this.this$0.mActivity.getWindow().getDecorView()) == 1;
            if (z) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = C0025a.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = C0025a.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (this.mDrawerLayout.mo1670h(8388611)) {
            this.mDrawerLayout.mo1661f(8388611);
        } else {
            this.mDrawerLayout.mo1660e(8388611);
        }
        return true;
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.mo1663g(8388611) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = C0025a.getDrawable(this.mActivity, i);
        }
    ...
    public void syncState() {
        if (this.mDrawerLayout.mo1663g(8388611)) {
            this.mSlider.setPosition(1.0f);
        } else {
            this.mSlider.setPosition(0.0f);
        }
