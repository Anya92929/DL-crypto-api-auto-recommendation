...
class NotificationCompatJellybean {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        /* renamed from: b */
        private Notification.Builder f162b;
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f162b, action));
        }

        public Notification build() {
            Notification build = this.f162b.build();
    ...
    public static android.support.p009v4.app.NotificationCompatBase.Action getAction(android.app.Notification r8, int r9, android.support.p009v4.app.NotificationCompatBase.Action.Factory r10, android.support.p009v4.app.RemoteInputCompatBase.RemoteInput.Factory r11) {
        /*
            r6 = 0
        ...
        L_0x004e:
            ...
            goto L_0x001f
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p009v4.app.NotificationCompatJellybean.getAction(android.app.Notification, int, android.support.v4.app.NotificationCompatBase$Action$Factory, android.support.v4.app.RemoteInputCompatBase$RemoteInput$Factory):android.support.v4.app.NotificationCompatBase$Action");
    }
