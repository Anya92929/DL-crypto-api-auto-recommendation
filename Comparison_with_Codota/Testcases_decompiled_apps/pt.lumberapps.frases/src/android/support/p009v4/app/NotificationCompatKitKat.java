...
class NotificationCompatKitKat {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        /* renamed from: b */
        private Notification.Builder f163b;
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f163b, action));
        }
        ...
        public Notification build() {
            ...
            this.f163b.setExtras(this.mExtras);
            return this.f163b.build();
        }
