...
import android.support.p009v4.p010a.C0044j;
...
public final class NavUtils {
    ...
    class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? C0044j.m160a(componentName) : new Intent().setComponent(componentName);
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) {
        ...
        return getParentActivityName(context, componentName2) == null ? C0044j.m160a(componentName2) : new Intent().setComponent(componentName2);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class cls) {
        ...
        return getParentActivityName(context, componentName) == null ? C0044j.m160a(componentName) : new Intent().setComponent(componentName);
    }
