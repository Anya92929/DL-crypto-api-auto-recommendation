...
public class zza {
    ...
    public static class C2021zza extends RuntimeException {
        public C2021zza(String str, Parcel parcel) {
            super(str + " Parcel: pos=" + parcel.dataPosition() + " size=" + parcel.dataSize());
        }
    }

    /* renamed from: a */
    private static void m3895a(Parcel parcel, int i, int i2) {
        int zza = zza(parcel, i);
        if (zza != i2) {
            throw new C2021zza("Expected size " + i2 + " got " + zza + " (0x" + Integer.toHexString(zza) + ")", parcel);
        }
    }

    /* renamed from: a */
    private static void m3896a(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C2021zza("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
    ...
    public static int zzau(Parcel parcel) {
        ...
        int dataPosition = parcel.dataPosition();
        if (zzca(zzat) != 20293) {
            throw new C2021zza("Expected object header. Got 0x" + Integer.toHexString(zzat), parcel);
        }
        int i = dataPosition + zza;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C2021zza("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
