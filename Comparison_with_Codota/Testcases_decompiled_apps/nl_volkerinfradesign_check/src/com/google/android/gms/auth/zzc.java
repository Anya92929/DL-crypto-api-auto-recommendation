...
public class zzc implements Parcelable.Creator<AccountChangeEventsResponse> {
    /* renamed from: a */
    static void m3651a(AccountChangeEventsResponse accountChangeEventsResponse, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, accountChangeEventsResponse.f2466a);
        zzb.zzc(parcel, 2, accountChangeEventsResponse.f2467b, false);
        zzb.zzI(parcel, zzav);
    }
