...
public class zzae implements Parcelable.Creator<ValidateAccountRequest> {
    /* renamed from: a */
    static void m3909a(ValidateAccountRequest validateAccountRequest, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, validateAccountRequest.f2929a);
        zzb.zzc(parcel, 2, validateAccountRequest.zzre());
        zzb.zza(parcel, 3, validateAccountRequest.f2930b, false);
