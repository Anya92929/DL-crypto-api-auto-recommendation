...
public class zzd implements Parcelable.Creator<FieldMappingDictionary.Entry> {
    /* renamed from: a */
    static void m3988a(FieldMappingDictionary.Entry entry, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, entry.f3055a);
        zzb.zza(parcel, 2, entry.f3056b, false);
        zzb.zzc(parcel, 3, entry.f3057c, false);
        zzb.zzI(parcel, zzav);
    }
