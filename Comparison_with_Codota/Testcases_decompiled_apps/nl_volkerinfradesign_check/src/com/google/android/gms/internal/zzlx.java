...
public interface zzlx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlx {
        ...
        /* renamed from: com.google.android.gms.internal.zzlx$zza$a */
        static class C0774a implements zzlx {

            /* renamed from: a */
            private IBinder f3181a;
            ...
            public void zzv(Status status) throws RemoteException {
                ...
                try {
                    ...
                    this.f3181a.transact(1, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public static zzlx zzaL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlx)) ? new C0774a(iBinder) : (zzlx) queryLocalInterface;
        }
