...
public interface zzy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzy {
        ...
        static class C0875a implements zzy {

            /* renamed from: a */
            private IBinder f3468a;
            ...
            public void onStreetViewPanoramaClick(StreetViewPanoramaOrientation streetViewPanoramaOrientation) throws RemoteException {
                ...
                try {
                    ...
                    this.f3468a.transact(1, obtain, obtain2, 0);
        ...
        public static zzy zzcU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzy)) ? new C0875a(iBinder) : (zzy) queryLocalInterface;
        }
