...
public class zzc implements Parcelable.Creator<StringToIntConverter.Entry> {
    /* renamed from: a */
    static void m3963a(StringToIntConverter.Entry entry, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, entry.f3045a);
        zzb.zza(parcel, 2, entry.f3046b, false);
        zzb.zzc(parcel, 3, entry.f3047c);
        zzb.zzI(parcel, zzav);
    }
