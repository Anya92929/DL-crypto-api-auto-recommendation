...
public class zzz implements Parcelable.Creator<ResolveAccountResponse> {
    /* renamed from: a */
    static void m3955a(ResolveAccountResponse resolveAccountResponse, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, resolveAccountResponse.f2920a);
        zzb.zza(parcel, 2, resolveAccountResponse.f2921b, false);
