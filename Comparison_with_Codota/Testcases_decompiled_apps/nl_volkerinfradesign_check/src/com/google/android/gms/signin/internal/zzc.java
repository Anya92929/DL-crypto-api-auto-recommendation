...
public class zzc implements Parcelable.Creator<CheckServerAuthResult> {
    /* renamed from: a */
    static void m4244a(CheckServerAuthResult checkServerAuthResult, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, checkServerAuthResult.f3593a);
        zzb.zza(parcel, 2, checkServerAuthResult.f3594b);
        zzb.zzc(parcel, 3, checkServerAuthResult.f3595c, false);
        zzb.zzI(parcel, zzav);
    }
