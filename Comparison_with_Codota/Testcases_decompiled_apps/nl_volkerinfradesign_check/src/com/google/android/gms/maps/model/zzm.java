...
public class zzm implements Parcelable.Creator<StreetViewPanoramaOrientation> {
    /* renamed from: a */
    static void m4225a(StreetViewPanoramaOrientation streetViewPanoramaOrientation, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, streetViewPanoramaOrientation.mo6966a());
