...
public class zzh implements Parcelable.Creator<PolygonOptions> {
    /* renamed from: a */
    static void m4220a(PolygonOptions polygonOptions, Parcel parcel, int i) {
        int zzav = zzb.zzav(parcel);
        zzb.zzc(parcel, 1, polygonOptions.mo6881a());
        zzb.zzc(parcel, 2, polygonOptions.getPoints(), false);
        zzb.zzd(parcel, 3, polygonOptions.mo6886b(), false);
