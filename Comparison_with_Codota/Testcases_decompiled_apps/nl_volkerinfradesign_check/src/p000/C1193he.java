...
/* renamed from: he */
public class C1193he {

    /* renamed from: he$a */
    public static abstract class C1194a {

        /* renamed from: a */
        private int f4254a;

        protected C1194a(byte[] bArr) {
            zzx.zzb(bArr.length == 25, (Object) "cert hash data has incorrect length");
            this.f4254a = Arrays.hashCode(bArr);
        }

        /* renamed from: a */
        protected static byte[] m5264a(String str) {
            try {
        ...
        /* renamed from: a */
        public abstract byte[] mo8272a();

        public boolean equals(Object obj) {
            if (obj == null || !(obj instanceof C1194a)) {
                return false;
            }
            return Arrays.equals(mo8272a(), ((C1194a) obj).mo8272a());
        }
    ...
    /* renamed from: he$b */
    public static class C1195b extends C1194a {

        /* renamed from: a */
        private final byte[] f4255a;

        public C1195b(byte[] bArr) {
    ...
    /* renamed from: he$c */
    static abstract class C1196c extends C1194a {

        /* renamed from: b */
        private static final WeakReference<byte[]> f4256b = new WeakReference<>((Object) null);

        /* renamed from: a */
        private WeakReference<byte[]> f4257a = f4256b;
        ...
        public byte[] mo8272a() {
            byte[] bArr;
            synchronized (this) {
                bArr = (byte[]) this.f4257a.get();
                if (bArr == null) {
                    bArr = mo8275b();
                    this.f4257a = new WeakReference<>(bArr);
                }
            }
            return bArr;
        }
