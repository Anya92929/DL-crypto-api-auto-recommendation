...
public abstract class SharedElementCallback {
    ...
    /* renamed from: b */
    private static int f415b = 1048576;
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
        ...
        if (view instanceof ImageView) {
            ...
            if (!(drawable == null || background != null || (a = m420a(drawable)) == null)) {
        ...
        float min = Math.min(1.0f, ((float) f415b) / ((float) (round * round2)));
        ...
        this.f416a.postTranslate(-rectF.left, -rectF.top);
        this.f416a.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f416a);
        view.draw(canvas);
        return createBitmap;
    }

    /* renamed from: a */
    private static Bitmap m420a(Drawable drawable) {
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth <= 0 || intrinsicHeight <= 0) {
            return null;
        }
        float min = Math.min(1.0f, ((float) f415b) / ((float) (intrinsicWidth * intrinsicHeight)));
