...
public interface IMediaControllerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaControllerCallback {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: android.support.v4.media.session.ParcelableVolumeInfo} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v6, resolved type: android.os.Bundle} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v20, resolved type: android.support.v4.media.MediaMetadataCompat} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v25, resolved type: android.support.v4.media.session.PlaybackStateCompat} */
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) throws android.os.RemoteException {
            ...
            L_0x0037:
                ...
                android.os.Parcelable$Creator<android.support.v4.media.session.PlaybackStateCompat> r0 = android.support.p001v4.media.session.PlaybackStateCompat.CREATOR
                java.lang.Object r0 = r0.createFromParcel(r6)
                android.support.v4.media.session.PlaybackStateCompat r0 = (android.support.p001v4.media.session.PlaybackStateCompat) r0
            L_0x004a:
            ...
            L_0x004f:
                ...
                android.os.Parcelable$Creator<android.support.v4.media.MediaMetadataCompat> r0 = android.support.p001v4.media.MediaMetadataCompat.CREATOR
                java.lang.Object r0 = r0.createFromParcel(r6)
            ...
            L_0x0067:
                java.lang.String r0 = "android.support.v4.media.session.IMediaControllerCallback"
                r6.enforceInterface(r0)
                android.os.Parcelable$Creator<android.support.v4.media.session.MediaSessionCompat$QueueItem> r0 = android.support.p001v4.media.session.MediaSessionCompat.QueueItem.CREATOR
            ...
            L_0x00a9:
                ...
                android.os.Parcelable$Creator<android.support.v4.media.session.ParcelableVolumeInfo> r0 = android.support.p001v4.media.session.ParcelableVolumeInfo.CREATOR
                java.lang.Object r0 = r0.createFromParcel(r6)
        ...
        static class C0182a implements IMediaControllerCallback {
            ...
            public void onEvent(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(1, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onSessionDestroyed() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    this.f659a.transact(2, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat playbackStateCompat) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(3, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onMetadataChanged(MediaMetadataCompat mediaMetadataCompat) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(4, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onQueueChanged(List<MediaSessionCompat.QueueItem> list) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(5, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onQueueTitleChanged(CharSequence charSequence) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(6, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onExtrasChanged(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(7, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException {
                ...
                try {
                    ...
                    this.f659a.transact(8, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
