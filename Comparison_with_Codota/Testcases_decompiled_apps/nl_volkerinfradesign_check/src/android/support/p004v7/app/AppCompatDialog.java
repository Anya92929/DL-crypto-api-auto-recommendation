...
public class AppCompatDialog extends Dialog implements AppCompatCallback {
    ...
    /* renamed from: a */
    private AppCompatDelegate f1555a;
    ...
    public AppCompatDialog(Context context, int i) {
        super(context, m2962a(context, i));
    ...
    public AppCompatDelegate getDelegate() {
        if (this.f1555a == null) {
            this.f1555a = AppCompatDelegate.create((Dialog) this, (AppCompatCallback) this);
        }
        return this.f1555a;
    }

    /* renamed from: a */
    private static int m2962a(Context context, int i) {
        if (i != 0) {
            return i;
        }
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0505R.attr.dialogTheme, typedValue, true);
