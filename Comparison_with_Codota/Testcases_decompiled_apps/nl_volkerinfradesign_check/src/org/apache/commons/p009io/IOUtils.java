...
import org.apache.commons.p009io.output.ByteArrayOutputStream;
import org.apache.commons.p009io.output.StringBuilderWriter;
...
public class IOUtils {
    ...
    /* renamed from: a */
    private static char[] f6845a;

    /* renamed from: b */
    private static byte[] f6846b;
    ...
    public static long skip(InputStream inputStream, long j) throws IOException {
        ...
        if (f6846b == null) {
            f6846b = new byte[2048];
        }
        long j2 = j;
        while (j2 > 0) {
            long read = (long) inputStream.read(f6846b, 0, (int) Math.min(j2, PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH));
            if (read < 0) {
                break;
            }
            j2 -= read;
    ...
    public static long skip(Reader reader, long j) throws IOException {
        ...
        if (f6845a == null) {
            f6845a = new char[2048];
        }
        long j2 = j;
        while (j2 > 0) {
            long read = (long) reader.read(f6845a, 0, (int) Math.min(j2, PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH));
            if (read < 0) {
                break;
            }
            j2 -= read;
