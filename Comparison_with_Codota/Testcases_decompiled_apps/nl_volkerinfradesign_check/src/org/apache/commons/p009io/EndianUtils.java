...
public class EndianUtils {
    ...
    public static short readSwappedShort(InputStream inputStream) throws IOException {
        return (short) (((m7255a(inputStream) & 255) << 0) + ((m7255a(inputStream) & 255) << 8));
    }

    public static int readSwappedUnsignedShort(InputStream inputStream) throws IOException {
        return ((m7255a(inputStream) & 255) << 0) + ((m7255a(inputStream) & 255) << 8);
    }
    ...
    public static int readSwappedInteger(InputStream inputStream) throws IOException {
        return ((m7255a(inputStream) & 255) << 0) + ((m7255a(inputStream) & 255) << 8) + ((m7255a(inputStream) & 255) << 16) + ((m7255a(inputStream) & 255) << 24);
    }

    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        return (((long) (((m7255a(inputStream) & 255) << 0) + ((m7255a(inputStream) & 255) << 8) + ((m7255a(inputStream) & 255) << 16))) & 4294967295L) + (((long) (m7255a(inputStream) & 255)) << 24);
    }
    ...
    public static long readSwappedLong(InputStream inputStream) throws IOException {
        ...
        for (int i = 0; i < 8; i++) {
            bArr[i] = (byte) m7255a(inputStream);
        }
    ...
    /* renamed from: a */
    private static int m7255a(InputStream inputStream) throws IOException {
