...
public class ColorUtils {
    ...
    public static int HSLToColor(float[] fArr) {
        ...
        return Color.rgb(m656a(round, 0, 255), m656a(round2, 0, 255), m656a(round3, 0, 255));
    }
    ...
    public static void RGBToHSL(int i, int i2, int i3, float[] fArr) {
        ...
        fArr[0] = m654a(f7, (float) BitmapDescriptorFactory.HUE_RED, 360.0f);
        fArr[1] = m654a(abs, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
        fArr[2] = m654a(f6, (float) BitmapDescriptorFactory.HUE_RED, 1.0f);
    }

    /* renamed from: a */
    private static float m654a(float f, float f2, float f3) {
        return f < f2 ? f2 : f > f3 ? f3 : f;
    }

    /* renamed from: a */
    private static int m655a(int i, int i2) {
        return 255 - (((255 - i2) * (255 - i)) / 255);
    }

    /* renamed from: a */
    private static int m656a(int i, int i2, int i3) {
        return i < i2 ? i2 : i > i3 ? i3 : i;
    }

    /* renamed from: a */
    private static int m657a(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int compositeColors(int i, int i2) {
        ...
        int a = m655a(alpha2, alpha);
        return Color.argb(a, m657a(Color.red(i), alpha2, Color.red(i2), alpha, a), m657a(Color.green(i), alpha2, Color.green(i2), alpha, a), m657a(Color.blue(i), alpha2, Color.blue(i2), alpha, a));
    }
