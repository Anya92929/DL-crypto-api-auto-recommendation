...
class ViewCompatLollipop {
    ...
    /* renamed from: a */
    static ColorStateList m884a(View view) {
        return view.getBackgroundTintList();
    }

    /* renamed from: a */
    static void m885a(View view, ColorStateList colorStateList) {
        view.setBackgroundTintList(colorStateList);
    }

    /* renamed from: a */
    static void m886a(View view, PorterDuff.Mode mode) {
        view.setBackgroundTintMode(mode);
    }

    /* renamed from: b */
    static PorterDuff.Mode m887b(View view) {
        return view.getBackgroundTintMode();
    }

    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0004, code lost:
        r0 = ((android.support.p000v4.view.WindowInsetsCompatApi21) r3).mo2606a();
    ...
    public static android.support.p000v4.view.WindowInsetsCompat dispatchApplyWindowInsets(android.view.View r2, android.support.p000v4.view.WindowInsetsCompat r3) {
        /*
            ...
            android.view.WindowInsets r0 = r0.mo2606a()
    ...
    public static void setOnApplyWindowInsetsListener(View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                return ((WindowInsetsCompatApi21) OnApplyWindowInsetsListener.this.onApplyWindowInsets(view, new WindowInsetsCompatApi21(windowInsets))).mo2606a();
            }
        });
    }
