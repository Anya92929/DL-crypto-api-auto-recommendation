...
public class ViewGroupCompat {
    ...
    /* renamed from: a */
    static final ViewGroupCompatImpl f1256a;
    ...
    static {
        ...
        if (i >= 21) {
            f1256a = new ViewGroupCompatLollipopImpl();
        } else if (i >= 18) {
            f1256a = new ViewGroupCompatJellybeanMR2Impl();
        } else if (i >= 14) {
            f1256a = new ViewGroupCompatIcsImpl();
        } else if (i >= 11) {
            f1256a = new ViewGroupCompatHCImpl();
        } else {
            f1256a = new ViewGroupCompatStubImpl();
        }
    }
    ...
    public static int getLayoutMode(ViewGroup viewGroup) {
        return f1256a.getLayoutMode(viewGroup);
    }

    public static int getNestedScrollAxes(ViewGroup viewGroup) {
        return f1256a.getNestedScrollAxes(viewGroup);
    }

    public static boolean isTransitionGroup(ViewGroup viewGroup) {
        return f1256a.isTransitionGroup(viewGroup);
    }

    public static boolean onRequestSendAccessibilityEvent(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
        return f1256a.onRequestSendAccessibilityEvent(viewGroup, view, accessibilityEvent);
    }

    public static void setLayoutMode(ViewGroup viewGroup, int i) {
        f1256a.setLayoutMode(viewGroup, i);
    }

    public static void setMotionEventSplittingEnabled(ViewGroup viewGroup, boolean z) {
        f1256a.setMotionEventSplittingEnabled(viewGroup, z);
    }

    public static void setTransitionGroup(ViewGroup viewGroup, boolean z) {
        f1256a.setTransitionGroup(viewGroup, z);
    }
}
