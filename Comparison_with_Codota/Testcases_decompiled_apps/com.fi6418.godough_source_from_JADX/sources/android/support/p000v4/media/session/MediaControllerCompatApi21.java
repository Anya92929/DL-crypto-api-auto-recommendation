...
class MediaControllerCompatApi21 {
    ...
    class CallbackProxy<T extends Callback> extends MediaController.Callback {
        ...
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            this.f920a.onMetadataChanged(mediaMetadata);
        }

        public void onPlaybackStateChanged(PlaybackState playbackState) {
            this.f920a.onPlaybackStateChanged(playbackState);
        }

        public void onSessionDestroyed() {
            this.f920a.onSessionDestroyed();
        }

        public void onSessionEvent(String str, Bundle bundle) {
            this.f920a.onSessionEvent(str, bundle);
        }
    }
    ...
    public class PlaybackInfo {
        /* renamed from: a */
        private static int m694a(AudioAttributes audioAttributes) {
        ...
        public static int getLegacyAudioStream(Object obj) {
            return m694a(getAudioAttributes(obj));
        }
