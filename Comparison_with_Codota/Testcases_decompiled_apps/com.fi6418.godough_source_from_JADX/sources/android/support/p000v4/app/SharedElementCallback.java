...
public abstract class SharedElementCallback {
    ...
    /* renamed from: b */
    private static int f709b = 1048576;

    /* renamed from: a */
    private Matrix f710a;

    /* renamed from: a */
    private static Bitmap m606a(Drawable drawable) {
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        if (intrinsicWidth <= 0 || intrinsicHeight <= 0) {
            return null;
        }
        float min = Math.min(1.0f, ((float) f709b) / ((float) (intrinsicWidth * intrinsicHeight)));
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
        ...
        if (view instanceof ImageView) {
            ...
            if (!(drawable == null || background != null || (a = m606a(drawable)) == null)) {
        ...
        float min = Math.min(1.0f, ((float) f709b) / ((float) (round * round2)));
        int i = (int) (((float) round) * min);
        int i2 = (int) (((float) round2) * min);
        if (this.f710a == null) {
            this.f710a = new Matrix();
        }
        this.f710a.set(matrix);
        this.f710a.postTranslate(-rectF.left, -rectF.top);
        this.f710a.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f710a);
        view.draw(canvas);
        return createBitmap;
    }
