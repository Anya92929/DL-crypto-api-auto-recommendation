...
public enum C0611a {
    ...
    LOCALE("locale"),
    LOCATION(LocationSearchCriteria.KEY_LOCATION),
    MAP("map"),
    MAX("max"),
    METRIC("metric"),
    MIN("min"),
    ...
    TITLE(ImageViewActivity.PARAM_TITLE),
    ...
    TYPE(ImageViewActivity.PARAM_TYPE),
    ...
    /* renamed from: dB */
    private final String f4209dB;

    private C0611a(String str) {
        this.f4209dB = str;
    }
