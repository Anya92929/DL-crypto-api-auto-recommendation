...
public interface zzp extends IInterface {
    ...
    public abstract class zza extends Binder implements zzp {
        ...
        public static zzp zzcB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzp)) ? new C1211y(iBinder) : (zzp) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zzq(C0606k.m3535a(parcel.readStrongBinder()));
