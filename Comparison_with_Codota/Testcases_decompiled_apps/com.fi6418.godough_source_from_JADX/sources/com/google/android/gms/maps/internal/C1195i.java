...
class C1195i implements IStreetViewPanoramaViewDelegate {

    /* renamed from: a */
    private IBinder f5094a;

    C1195i(IBinder iBinder) {
        this.f5094a = iBinder;
    }
    ...
    public void getStreetViewPanoramaAsync(zzv zzv) {
        ...
        try {
            ...
            this.f5094a.transact(9, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public C0605j getView() {
        ...
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.f5094a.transact(8, obtain, obtain2, 0);
            obtain2.readException();
    ...
    public void onDestroy() {
        ...
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.f5094a.transact(5, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public void onLowMemory() {
        ...
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.f5094a.transact(6, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public void onPause() {
        ...
        try {
            obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.f5094a.transact(4, obtain, obtain2, 0);
            obtain2.readException();
        } finally {
            obtain2.recycle();
            obtain.recycle();
    ...
    public void onSaveInstanceState(Bundle bundle) {
        ...
        try {
            ...
            this.f5094a.transact(7, obtain, obtain2, 0);
            obtain2.readException();
