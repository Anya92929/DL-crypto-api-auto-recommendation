...
class C0664f implements C0662d {

    /* renamed from: a */
    private IBinder f4359a;

    C0664f(IBinder iBinder) {
        this.f4359a = iBinder;
    }
    ...
    /* renamed from: a */
    public String mo7200a(String str) {
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
            obtain.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
    ...
    /* renamed from: a */
    public void mo7201a(String str, boolean z) {
        int i = 0;
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
    ...
    /* renamed from: a */
    public boolean mo7202a(boolean z) {
        boolean z2 = true;
        Parcel obtain = Parcel.obtain();
        Parcel obtain2 = Parcel.obtain();
        try {
