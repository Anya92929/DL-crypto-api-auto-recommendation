...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class C1810a extends Binder implements IUiSettingsDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IUiSettingsDelegate$a$a */
        private static class C1811a implements IUiSettingsDelegate {

            /* renamed from: lb */
            private IBinder f4447lb;

            C1811a(IBinder iBinder) {
                this.f4447lb = iBinder;
            }
            ...
            public boolean isCompassEnabled() throws RemoteException {
                ...
                try {
                    ...
                    this.f4447lb.transact(10, obtain, obtain2, 0);
            ...
            public boolean isIndoorLevelPickerEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(17, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isMyLocationButtonEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isRotateGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(15, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isScrollGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isTiltGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(14, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomControlsEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f4447lb.transact(13, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public void setAllGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setCompassEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setIndoorLevelPickerEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(16, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setMyLocationButtonEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setRotateGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setScrollGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setTiltGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomControlsEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4447lb.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: bo */
        public static IUiSettingsDelegate m6328bo(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IUiSettingsDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C1811a(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
