...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class C1800a extends Binder implements IMapViewDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapViewDelegate$a$a */
        private static class C1801a implements IMapViewDelegate {

            /* renamed from: lb */
            private IBinder f4442lb;

            C1801a(IBinder iBinder) {
                this.f4442lb = iBinder;
            }
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    this.f4442lb.transact(1, obtain, obtain2, 0);
            ...
            public C0594d getView() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f4442lb.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void onCreate(Bundle savedInstanceState) throws RemoteException {
                ...
                try {
                    ...
                    this.f4442lb.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f4442lb.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onLowMemory() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f4442lb.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onPause() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f4442lb.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onResume() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f4442lb.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSaveInstanceState(Bundle outState) throws RemoteException {
                ...
                try {
                    ...
                    this.f4442lb.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        /* renamed from: aU */
        public static IMapViewDelegate m6323aU(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C1801a(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r4, android.os.Parcel r5, android.os.Parcel r6, int r7) throws android.os.RemoteException {
            ...
            L_0x00b2:
                ...
                goto L_0x0009
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.maps.internal.IMapViewDelegate.C1800a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
