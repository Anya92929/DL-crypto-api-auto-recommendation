...
public interface C1822e extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.e$a */
    public static abstract class C1823a extends Binder implements C1822e {

        /* renamed from: com.google.android.gms.maps.internal.e$a$a */
        private static class C1824a implements C1822e {

            /* renamed from: lb */
            private IBinder f4451lb;

            C1824a(IBinder iBinder) {
                this.f4451lb = iBinder;
            }
            ...
            public void onCameraChange(CameraPosition position) throws RemoteException {
                ...
                try {
                    ...
                    this.f4451lb.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: aV */
        public static C1822e m6354aV(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnCameraChangeListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1822e)) ? new C1824a(iBinder) : (C1822e) queryLocalInterface;
        }
