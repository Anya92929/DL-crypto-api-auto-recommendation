...
public class DedicatedVPNActivity extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(C2344R.layout.new_product_2, container, false);
        Typeface regular = Typeface.createFromAsset(getActivity().getAssets(), "fonts/Roboto-Regular.ttf");
        ((TextView) rootView.findViewById(C2344R.C2346id.dedicated_content)).setTypeface(regular);
        ...
        ((TextView) rootView.findViewById(C2344R.C2346id.dedicated_title)).setTypeface(bold);
        ...
        ((Button) rootView.findViewById(C2344R.C2346id.btn_order)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(DedicatedVPNActivity.this.getActivity(), OrderActivity.class);
                i.putExtra(Prop.EXTRA_SKU, "Dedicated VPN");
                DedicatedVPNActivity.this.startActivity(i);
            }
        });
