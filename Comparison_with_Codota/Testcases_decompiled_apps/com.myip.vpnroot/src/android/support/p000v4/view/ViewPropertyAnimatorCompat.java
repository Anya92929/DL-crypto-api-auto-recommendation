...
public class ViewPropertyAnimatorCompat {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo1413x(View view, float f);

        void xBy(View view, float f);

        /* renamed from: y */
        void mo1415y(View view, float f);
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo1413x(View view, float value) {
        }
        ...
        /* renamed from: y */
        public void mo1415y(View view, float value) {
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo1381x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo1413x(view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo1383y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo1415y(view, value);
        }
        return this;
    }
