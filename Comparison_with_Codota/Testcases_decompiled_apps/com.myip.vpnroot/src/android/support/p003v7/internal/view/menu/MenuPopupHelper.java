...
import android.support.p003v7.internal.widget.ListPopupWindow;
...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, PopupWindow.OnDismissListener, MenuPresenter {
    static final int ITEM_LAYOUT = C0091R.layout.abc_popup_menu_item_layout;
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0091R.dimen.abc_config_prefDialogWidth));
    ...
    public boolean tryShow() {
        ...
        this.mPopup = new ListPopupWindow(this.mContext, (AttributeSet) null, C0091R.attr.popupMenuStyle);
