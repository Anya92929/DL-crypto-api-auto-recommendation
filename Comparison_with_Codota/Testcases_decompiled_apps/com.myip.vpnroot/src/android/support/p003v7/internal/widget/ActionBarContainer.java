...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0091R.styleable.ActionBar);
        this.mBackground = a.getDrawable(10);
        this.mStackedBackground = a.getDrawable(11);
        if (getId() == C0091R.C0093id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = (ActionBarView) findViewById(C0091R.C0093id.action_bar);
    }
