...
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0091R.styleable.ActionBar, C0091R.attr.actionBarStyle, 0);
        ...
        int homeResId = a.getResourceId(14, C0091R.layout.abc_action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0091R.string.abc_action_bar_up_description));
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0091R.C0093id.progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0091R.C0093id.progress_circular);
    ...
    public void setSplitActionBar(boolean splitActionBar) {
        if (this.mSplitActionBar != splitActionBar) {
            ...
            if (this.mActionMenuPresenter != null) {
                if (!splitActionBar) {
                    this.mActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(C0091R.bool.abc_action_bar_expanded_action_views_exclusive));
                } else {
    ...
    public void setMenu(SupportMenu menu, MenuPresenter.Callback cb) {
        ...
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0091R.C0093id.action_menu_presenter);
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0091R.string.abc_action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0091R.string.abc_action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case 1:
                    if (this.mSpinner == null) {
                        this.mSpinner = new SpinnerICS(this.mContext, (AttributeSet) null, C0091R.attr.actionDropDownStyle);
                        this.mListNavLayout = (LinearLayout) LayoutInflater.from(this.mContext).inflate(C0091R.layout.abc_action_bar_view_list_nav_layout, (ViewGroup) null);
    ...
    public void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0091R.layout.abc_action_bar_title_item, this, false);
            ...
            this.mTitleUpView = this.mTitleLayout.findViewById(C0091R.C0093id.f5up);
    ...
    private static class HomeView extends FrameLayout {
        ...
        /* access modifiers changed from: protected */
        public void onFinishInflate() {
            this.mUpView = (ImageView) findViewById(C0091R.C0093id.f5up);
            this.mIconView = (ImageView) findViewById(C0091R.C0093id.home);
            ...
            if (this.mCurrentExpandedItem != null) {
                ...
                if (this.mMenu != null) {
                    ...
                    while (true) {
                        if (i >= count) {
                            break;
                        } else if (((SupportMenuItem) this.mMenu.getItem(i)) == this.mCurrentExpandedItem) {
                            found = true;
                            break;
                        } else {
                            i++;
