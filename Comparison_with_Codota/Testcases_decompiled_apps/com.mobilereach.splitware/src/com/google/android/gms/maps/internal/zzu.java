...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C0494zza implements zzu {
        ...
        public static zzu zzcQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzu)) ? new C0494zza(iBinder) : (zzu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzg.zza.zzdj(data.readStrongBinder()));
