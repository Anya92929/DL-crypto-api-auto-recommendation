...
public interface zzmk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmk {
        ...
        private static class C0446zza implements zzmk {
        ...
        public static zzmk zzaX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmk)) ? new C0446zza(iBinder) : (zzmk) queryLocalInterface;
        }
