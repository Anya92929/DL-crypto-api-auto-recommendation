...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C0485zza implements zzl {
            private IBinder zzoz;

            C0485zza(IBinder iBinder) {
                this.zzoz = iBinder;
            }
        ...
        public static zzl zzcH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C0485zza(iBinder) : (zzl) queryLocalInterface;
        }
