...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class C0468zza implements IProjectionDelegate {
        ...
        public static IProjectionDelegate zzcX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0468zza(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(zzd.zza.zzbs(data.readStrongBinder()));
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    zzd screenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
