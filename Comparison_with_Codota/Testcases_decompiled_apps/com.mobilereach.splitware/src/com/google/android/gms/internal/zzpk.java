...
public interface zzpk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpk {
        ...
        private static class C0448zza implements zzpk {
        ...
        public static zzpk asInterface(IBinder obj) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpk)) ? new C0448zza(obj) : (zzpk) queryLocalInterface;
        }
