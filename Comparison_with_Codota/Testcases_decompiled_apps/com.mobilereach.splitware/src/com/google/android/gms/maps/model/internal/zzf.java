...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        private static class C0507zza implements zzf {
            private IBinder zzoz;

            C0507zza(IBinder iBinder) {
                this.zzoz = iBinder;
            }
        ...
        public static zzf zzdi(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C0507zza(iBinder) : (zzf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    boolean zzj = zzj(zzdi(data.readStrongBinder()));
                    reply.writeNoException();
                    if (zzj) {
                        z = true;
                    }
                ...
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    zzw(zzd.zza.zzbs(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
