...
public class FACLConfig implements SafeParcelable {
    ...
    FACLConfig(int version2, boolean isAllCirclesVisible, String visibleEdges, boolean isAllContactsVisible, boolean showCircles, boolean showContacts, boolean hasShowCircles) {
