...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class C0483zza implements zzj {
            private IBinder zzoz;

            C0483zza(IBinder iBinder) {
                this.zzoz = iBinder;
            }
        ...
        public static zzj zzcF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C0483zza(iBinder) : (zzj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zzi(zzf.zza.zzdi(data.readStrongBinder()));
