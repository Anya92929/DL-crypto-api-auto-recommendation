...
public interface zzf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzf {
        ...
        private static class C0479zza implements zzf {
        ...
        public static zzf zzcB(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzf)) ? new C0479zza(iBinder) : (zzf) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzc.zza.zzdf(data.readStrongBinder()));
