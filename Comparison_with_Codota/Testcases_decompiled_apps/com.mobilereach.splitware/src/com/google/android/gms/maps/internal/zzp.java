...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C0489zza implements zzp {
        ...
        public static zzp zzcL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzp)) ? new C0489zza(iBinder) : (zzp) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    boolean zzd = zzd(zzf.zza.zzdi(data.readStrongBinder()));
