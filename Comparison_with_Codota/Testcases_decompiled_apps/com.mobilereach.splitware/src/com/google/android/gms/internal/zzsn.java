            ...
            if (charAt2 < 128 && i6 < i5) {
                ...
                if (i4 + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        int i10 = i6 + 1;
                        bArr[i6] = (byte) ((codePoint >>> 18) | SktSsiProtocol.kSsiSubCmdRestoreFactoryDefaults);
                        int i11 = i10 + 1;
            ...
            if (charAt < 128) {
                ...
                if (i + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        byteBuffer.put((byte) ((codePoint >>> 18) | SktSsiProtocol.kSsiSubCmdRestoreFactoryDefaults));
