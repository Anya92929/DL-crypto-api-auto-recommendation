...
public class zze {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0171R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            if (!zzmu.zzaw(context)) {
                try {
                    zzd.zza zza = zzoO.zza(packageManager.getPackageInfo("com.android.vending", 8256), zzd.C0436zzd.zzafK);
                    if (zza == null) {
            ...
            } else if (zzoO.zza(packageInfo, zzd.C0436zzd.zzafK) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    public static boolean zzb(PackageManager packageManager) {
        ...
        synchronized (zzqy) {
            if (zzafN == -1) {
                try {
                    if (zzf.zzoO().zza(packageManager.getPackageInfo("com.google.android.gms", 64), zzd.C0436zzd.zzafK[1]) != null) {
                        zzafN = 1;
                    } else {
                        zzafN = 0;
                    }
