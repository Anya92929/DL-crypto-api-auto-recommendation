...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0484zza implements zzk {
            private IBinder zzoz;

            C0484zza(IBinder iBinder) {
                this.zzoz = iBinder;
            }
        ...
        public static zzk zzcG(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzk)) ? new C0484zza(iBinder) : (zzk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zzu(zzd.zza.zzbs(data.readStrongBinder()));
