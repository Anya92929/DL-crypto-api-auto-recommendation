...
public interface zzlx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlx {
        ...
        private static class C0443zza implements zzlx {
        ...
        public static zzlx zzaL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzlx)) ? new C0443zza(iBinder) : (zzlx) queryLocalInterface;
        }
