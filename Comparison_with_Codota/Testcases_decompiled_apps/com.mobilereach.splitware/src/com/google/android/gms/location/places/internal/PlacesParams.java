...
public class PlacesParams implements SafeParcelable {
    ...
    public PlacesParams(int versionCode2, String clientPackageName, String localeString, String accountName, String gCoreClientName, int gCoreClientJarVersion, int requestSource) {
    ...
    public PlacesParams(String clientPackageName, Locale locale, String accountName) {
        this(3, clientPackageName, locale.toString(), accountName, (String) null, GoogleApiAvailability.GOOGLE_PLAY_SERVICES_VERSION_CODE, 0);
    }
