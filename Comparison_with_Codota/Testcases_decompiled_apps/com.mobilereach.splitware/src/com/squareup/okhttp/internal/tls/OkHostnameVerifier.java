...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private boolean verifyHostName(String hostName, X509Certificate certificate) {
        ...
        if (hasDns || (cn = new DistinguishedNameParser(certificate.getSubjectX500Principal()).findMostSpecific("cn")) == null) { // CRYPTOGRAPHIC API CALLSITE 5
            return false;
        }
    ...
    private static List<String> getSubjectAltNames(X509Certificate certificate, int type) {
        ...
        try {
            Collection<List<?>> subjectAlternativeNames = certificate.getSubjectAlternativeNames(); // CRYPTOGRAPHIC API CALLSITE 3
