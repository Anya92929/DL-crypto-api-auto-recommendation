...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f22dn;
    private int end;
    private final int length = this.f22dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal principal) {
        this.f22dn = principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f22dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f22dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f22dn.toCharArray();
