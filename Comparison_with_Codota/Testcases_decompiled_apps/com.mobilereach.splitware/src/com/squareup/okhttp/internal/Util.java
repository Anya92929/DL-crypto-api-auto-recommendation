...
public final class Util {
    ...
    public static String md5Hex(String s) {
        try {
            return ByteString.m20of(MessageDigest.getInstance("MD5").digest(s.getBytes("UTF-8"))).hex(); // CRYPTOGRAPHIC API CALLSITE 1, CRYPTOGRAPHIC API CALLSITE 7
    ...
    public static String shaBase64(String s) {
        try {
            return ByteString.m20of(MessageDigest.getInstance("SHA-1").digest(s.getBytes("UTF-8"))).base64(); // CRYPTOGRAPHIC API CALLSITE 19, CRYPTOGRAPHIC API CALLSITE 20
        } catch (UnsupportedEncodingException | NoSuchAlgorithmException e) {
            throw new AssertionError(e);
        }
    }
    ...
    public static ByteString sha1(ByteString s) {
        try {
            return ByteString.m20of(MessageDigest.getInstance("SHA-1").digest(s.toByteArray())); // CRYPTOGRAPHIC API CALLSITE 14, CRYPTOGRAPHIC API CALLSITE 15
