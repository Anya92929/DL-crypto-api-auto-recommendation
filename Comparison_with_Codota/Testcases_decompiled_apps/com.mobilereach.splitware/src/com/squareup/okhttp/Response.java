...
public final class Response {
    ...
    public boolean isRedirect() {
        switch (this.code) {
            case SktSsiProtocol.kSsiSubCmdSetLocalDecodeAction:
            case SktSsiProtocol.kSsiSubCmdLocalDecodeActionInquiry:
            case SktSsiProtocol.kSsiSubCmdLocalDecodeActionResponse:
            case SktSsiProtocol.kSsiSubCmdRumbleConfigurationInquiry:
            case 307:
            case 308:
                return true;
            default:
