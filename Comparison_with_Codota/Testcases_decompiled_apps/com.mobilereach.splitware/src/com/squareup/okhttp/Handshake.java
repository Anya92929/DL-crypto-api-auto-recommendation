...
public final class Handshake {
    ...
    public Principal peerPrincipal() {
        if (!this.peerCertificates.isEmpty()) {
            return ((X509Certificate) this.peerCertificates.get(0)).getSubjectX500Principal(); // CRYPTOGRAPHIC API CALLSITE 9
        }
        return null;
    }
    ...
    public Principal localPrincipal() {
        if (!this.localCertificates.isEmpty()) {
            return ((X509Certificate) this.localCertificates.get(0)).getSubjectX500Principal(); // CRYPTOGRAPHIC API CALLSITE 17
        }
        return null;
    }
