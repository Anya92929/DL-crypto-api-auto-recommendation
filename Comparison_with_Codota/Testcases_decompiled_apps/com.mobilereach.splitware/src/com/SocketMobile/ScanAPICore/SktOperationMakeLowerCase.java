...
class SktOperationMakeLowerCase extends SktOperation {
    public SktOperationMakeLowerCase(SktDataEditingProfile dataEditingProfile) {
    ...
    public long run(SktOperationResult[] result) {
        ...
        return SktDebug.DBGSKT_EVAL(result[0].WriteResult(ResultParam1[0].getResultString().toLowerCase()), "result[0].WriteResult(stringResult)");
    }
