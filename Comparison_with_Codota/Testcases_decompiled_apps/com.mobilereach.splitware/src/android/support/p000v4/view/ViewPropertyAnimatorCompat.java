...
public final class ViewPropertyAnimatorCompat {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo2477x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo2479y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo2481z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo2477x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo2479y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo2481z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
        ...
        public void startAnimation(ViewPropertyAnimatorCompat vpa, View view) {
            ...
            Runnable unused = vpa.mStartAction = null;
            Runnable unused2 = vpa.mEndAction = null;
            if (startAction != null) {
                startAction.run();
            }
            if (listener != null) {
        ...
        static class MyVpaListener implements ViewPropertyAnimatorListener {
            ...
            public void onAnimationStart(View view) {
                ...
                if (this.mVpa.mStartAction != null) {
                    ...
                    Runnable unused = this.mVpa.mStartAction = null;
                    startAction.run();
                }
                Object listenerTag = view.getTag(ViewPropertyAnimatorCompat.LISTENER_TAG_ID);
                ViewPropertyAnimatorListener listener = null;
            ...
            public void onAnimationEnd(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 16 || !this.mAnimEndCalled) {
                    if (this.mVpa.mEndAction != null) {
                        ...
                        Runnable unused2 = this.mVpa.mEndAction = null;
                        endAction.run();
                    }
                    Object listenerTag = view.getTag(ViewPropertyAnimatorCompat.LISTENER_TAG_ID);
                    ViewPropertyAnimatorListener listener = null;
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2440x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2477x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2442y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2479y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2444z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2481z(this, view, value);
        }
        return this;
    }
