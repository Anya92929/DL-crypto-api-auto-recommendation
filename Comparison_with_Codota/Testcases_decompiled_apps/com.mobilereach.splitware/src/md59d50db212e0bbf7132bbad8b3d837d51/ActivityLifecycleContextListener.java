...
public class ActivityLifecycleContextListener implements IGCUserPeer, Application.ActivityLifecycleCallbacks {
    ...
    static {
        Runtime.register("ZXing.Mobile.ActivityLifecycleContextListener, ZXingNetMobile, Version=2.0.4.46, Culture=neutral, PublicKeyToken=null", ActivityLifecycleContextListener.class, __md_methods);
    }

    public ActivityLifecycleContextListener() throws Throwable {
        if (getClass() == ActivityLifecycleContextListener.class) {
            TypeManager.Activate("ZXing.Mobile.ActivityLifecycleContextListener, ZXingNetMobile, Version=2.0.4.46, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
