...
public class ComboBox extends FieldBase implements IGCUserPeer {
    public static final String __md_methods = "";
    private ArrayList refList;

    static {
        Runtime.register("Controls.ComboBox, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", ComboBox.class, __md_methods);
    }

    public ComboBox(Context context) throws Throwable {
        super(context);
        if (getClass() == ComboBox.class) {
            TypeManager.Activate("Controls.ComboBox, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context});
        }
    }

    public ComboBox(Context context, AttributeSet attributeSet) throws Throwable {
        super(context, attributeSet);
        if (getClass() == ComboBox.class) {
            TypeManager.Activate("Controls.ComboBox, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context, attributeSet});
        }
    }

    public ComboBox(Context context, AttributeSet attributeSet, int i) throws Throwable {
