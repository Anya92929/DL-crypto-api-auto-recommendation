...
public class AwaitableResultCallback_1 implements IGCUserPeer, ResultCallback {
    ...
    static {
        Runtime.register("Android.Gms.Common.Apis.AwaitableResultCallback`1, Xamarin.GooglePlayServices.Basement, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AwaitableResultCallback_1.class, __md_methods);
    }

    public AwaitableResultCallback_1() throws Throwable {
        if (getClass() == AwaitableResultCallback_1.class) {
            TypeManager.Activate("Android.Gms.Common.Apis.AwaitableResultCallback`1, Xamarin.GooglePlayServices.Basement, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new Object[0]);
        }
    }
