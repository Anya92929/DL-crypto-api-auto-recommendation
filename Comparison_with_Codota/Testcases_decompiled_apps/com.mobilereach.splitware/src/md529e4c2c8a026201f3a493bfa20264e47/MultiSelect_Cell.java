...
public class MultiSelect_Cell extends TableCell_2 implements IGCUserPeer {
    public static final String __md_methods = "";
    private ArrayList refList;

    static {
        Runtime.register("UI.MultiSelect+Cell, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", MultiSelect_Cell.class, __md_methods);
    }

    public MultiSelect_Cell(Context context) throws Throwable {
        super(context);
        if (getClass() == MultiSelect_Cell.class) {
            TypeManager.Activate("UI.MultiSelect+Cell, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context});
        }
    }

    public MultiSelect_Cell(Context context, AttributeSet attributeSet) throws Throwable {
        super(context, attributeSet);
        if (getClass() == MultiSelect_Cell.class) {
            TypeManager.Activate("UI.MultiSelect+Cell, Splitware, Version=1.0.6080.25359, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new Object[]{context, attributeSet});
        }
    }

    public MultiSelect_Cell(Context context, AttributeSet attributeSet, int i) throws Throwable {
