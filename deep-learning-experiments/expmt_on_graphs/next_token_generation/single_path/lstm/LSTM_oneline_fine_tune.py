...
parser.add_argument('--lstm_checkpoint_path',dest='lstm_checkpoint_path',type=str)
parser.add_argument('--lstm_checkpoint', dest = 'lstm_checkpoint',type=str)
...
lstm_checkpoint = args.lstm_checkpoint_path+'/'+args.lstm_checkpoint
...
class Model:
    ...
    def fine_tune(self,lstm_checkpoint, train_input,test_input,epoch,batch_size,save_checkpoint):
...
lstm_model.fine_tune(lstm_checkpoint,train_input,test_input,epoch,batch_size,save_checkpoint)
