...
class BertModel(object):
  ...
  def __init__(self,
    ...
    with tf.variable_scope("bert",reuse=tf.compat.v1.AUTO_REUSE):
      ...
      with tf.variable_scope("pooler",reuse=tf.compat.v1.AUTO_REUSE):
...
def get_assignment_map_from_checkpoint(tvars, init_checkpoint):
  ...
  tf.logging.info("parsed names from current graph: ")
  for key in name_to_variable:
    tf.logging.info(key)
  init_vars = tf.train.list_variables(init_checkpoint)
  tf.logging.info("parsed names from init_checkpoint")
